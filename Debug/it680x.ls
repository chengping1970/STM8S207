...
1181  0063 84            	pop	a
1182  0064               L154:
1183                     ; 794 	return mDataIn;
1185  0064 7b02          	ld	a,(OFST+0,sp)
1188  0066 5b03          	addw	sp,#3
1189  0068 87            	retf
1236                     ; 797 static unsigned char hdmirxwr( unsigned char RegAddr,unsigned char DataIn)
1236                     ; 798 {
1237                     	switch	.text
...
1245                     ; 803 	flag= i2c_write_byte(HDMI_ADDR, RegAddr, 1, &DataIn, HDMI_DEV);
...
1263                     ; 806 	MHLRX_DEBUG_PRINTF(printf("====================================\r\n"));
1265  0084 ae2c7f        	ldw	x,#L105
1266  0087 8d000000      	callf	f_printf
1268                     ; 807 	MHLRX_DEBUG_PRINTF(printf("HDMI I2C ERROR !!!"));
1270  008b ae2c6c        	ldw	x,#L305
1271  008e 8d000000      	callf	f_printf
1273                     ; 808 	MHLRX_DEBUG_PRINTF(printf("=====  Write Reg0x%x=%x =====  \r\n",RegAddr,DataIn));
...
1301  00b2 87            	retf
1355                     ; 814 static unsigned char  hdmirxset( unsigned char  offset, unsigned char  mask, unsigned char  ucdata )
1355                     ; 815 {
1356                     	switch	.text
...
1381                     ; 819 	return hdmirxwr(offset, temp);
...
1392  00d9 87            	retf
1449                     ; 822 static void hdmirxbwr( unsigned char offset, unsigned char byteno, unsigned char *rddata )
1449                     ; 823 {
1450                     	switch	.text
...
1458                     ; 825 	if( byteno>0 )
1460  00dc 9f            	ld	a,xl
1461  00dd 4d            	tnz	a
1462  00de 2714          	jreq	L555
1463                     ; 826 	flag= i2c_write_byte(HDMI_ADDR, offset, byteno, rddata, HDMI_DEV);
...
1482                     ; 829 	MHLRX_DEBUG_PRINTF(printf("====================================\r\n"));
1484  00f8 ae2c7f        	ldw	x,#L105
1485  00fb 8d000000      	callf	f_printf
1487                     ; 830 	MHLRX_DEBUG_PRINTF(printf("IT6802 I2C ERROR !!!"));
1489  00ff ae2c35        	ldw	x,#L165
1490  0102 8d000000      	callf	f_printf
1492                     ; 831 	MHLRX_DEBUG_PRINTF(printf("=====  Write Reg0x%x=%x =====  \r\n",offset,rddata));
...
1502                     ; 832 	MHLRX_DEBUG_PRINTF(printf("====================================\r\n"));
...
1512  011e 87            	retf
1559                     ; 837 static unsigned char mhlrxrd( unsigned char offset )
1559                     ; 838 {
1560                     	switch	.text
...
1568                     ; 841 	FLAG=i2c_read_byte(MHL_ADDR, offset, 1, &mDataIn, HDMI_DEV);
...
1585                     ; 844 	MHLRX_DEBUG_PRINTF(printf("====================================\r\n"));
1587  0138 ae2c7f        	ldw	x,#L105
1588  013b 8d000000      	callf	f_printf
1590                     ; 845 	MHLRX_DEBUG_PRINTF(printf("MHL I2C ERROR !!!"));
1592  013f ae2c23        	ldw	x,#L506
1593  0142 8d000000      	callf	f_printf
1595                     ; 846 	MHLRX_DEBUG_PRINTF(printf("=====  read Reg0x%x=%x =====  \r\n",offset,mDataIn));
...
1604  0153 85            	popw	x
1605                     ; 847 	MHLRX_DEBUG_PRINTF(printf("====================================\r\n"));
1607  0154 ae2c7f        	ldw	x,#L105
1608  0157 8d000000      	callf	f_printf
1610  015b               L306:
1611                     ; 849 	return mDataIn;
1613  015b 7b02          	ld	a,(OFST+0,sp)
1616  015d 5b03          	addw	sp,#3
1617  015f 87            	retf
1664                     ; 852 static unsigned char mhlrxwr( unsigned char offset, unsigned char ucdata )
1664                     ; 853 {
1665                     	switch	.text
...
1673                     ; 855 	flag= i2c_write_byte(MHL_ADDR, offset, 1, &ucdata, HDMI_DEV);
...
1691                     ; 858 	MHLRX_DEBUG_PRINTF(printf("====================================\r\n"));
1693  017b ae2c7f        	ldw	x,#L105
1694  017e 8d000000      	callf	f_printf
1696                     ; 859 	MHLRX_DEBUG_PRINTF(printf("MHL I2C ERROR !!!"));
1698  0182 ae2c23        	ldw	x,#L506
1699  0185 8d000000      	callf	f_printf
1701                     ; 860 	MHLRX_DEBUG_PRINTF(printf("=====  Write Reg0x%x=%x =====  \r\n",offset,ucdata));
...
1729  01a9 87            	retf
1783                     ; 866 static unsigned char mhlrxset( unsigned char offset, unsigned char mask, unsigned char ucdata )
1783                     ; 867 {
1784                     	switch	.text
...
1809                     ; 871 	return mhlrxwr(offset, temp);
...
1820  01d0 87            	retf
1869                     ; 874 static void mhlrxbrd( unsigned char offset, unsigned char byteno, unsigned char *rddata )
1869                     ; 875 {
1870                     	switch	.text
1871  01d1               L101f_mhlrxbrd:
1873  01d1 89            	pushw	x
1874       00000000      OFST:	set	0
1877                     ; 876 	if( byteno>0 )
1879  01d2 9f            	ld	a,xl
1880  01d3 4d            	tnz	a
1881  01d4 2712          	jreq	L776
1882                     ; 877 	i2c_read_byte(MHL_ADDR, offset, byteno, rddata, HDMI_DEV);
...
1899  01e8 85            	popw	x
1900  01e9 87            	retf
1949                     ; 880 static void mhlrxbwr( unsigned char offset, unsigned char byteno, unsigned char *rddata )
1949                     ; 881 {
1950                     	switch	.text
1951  01ea               L301f_mhlrxbwr:
1953  01ea 89            	pushw	x
1954       00000000      OFST:	set	0
1957                     ; 882 	if( byteno>0 )
1959  01eb 9f            	ld	a,xl
1960  01ec 4d            	tnz	a
1961  01ed 2712          	jreq	L327
1962                     ; 883 	i2c_write_byte(MHL_ADDR, offset, byteno, rddata, HDMI_DEV);
...
1979  0201 85            	popw	x
1980  0202 87            	retf
2997                     ; 890 static struct it6802_dev_data* get_it6802_dev_data(void)
2997                     ; 891 {
2998                     	switch	.text
2999  0203               L501f_get_it6802_dev_data:
3003                     ; 892 	return &it6802DEV;
3005  0203 ae0031        	ldw	x,#_it6802DEV
3008  0206 87            	retf
3080                     ; 896 static void hdimrx_write_init(struct IT6802_REG_INI _CODE *tdata)
3080                     ; 897 {
3081                     	switch	.text
...
3095  020e               L7051:
3096                     ; 902 		hdmirxset(tdata[cnt].ucAddr,tdata[cnt].andmask,tdata[cnt].ucValue);
...
3129  024b               L3151:
3130                     ; 899 	while(tdata[cnt].ucAddr != 0xFF)
...
3144  025f 87            	retf
3188                     ; 908 static void mhlrx_write_init(struct IT6802_REG_INI _CODE *tdata)
3188                     ; 909 {
3189                     	switch	.text
...
3203  0267               L1451:
3204                     ; 914 		mhlrxset(tdata[cnt].ucAddr,tdata[cnt].andmask,tdata[cnt].ucValue);
...
3237  02a4               L5451:
3238                     ; 911 	while(tdata[cnt].ucAddr != 0xFF)
...
3539                     ; 995 	    hdmirxset(0xC0, 0x80, 0x00);
...
3555  0366               L3361:
3556                     ; 1000 		hdmirxset(0x77, 0x80, 0x80);
...
3570                     ; 1002 		hdmirxset(0xC0, 0x80, 0x80);
...
3644                     ; 1020 		hdmirxset(0x20, 0x40, 0x40);
...
3684                     ; 1030 		hdmirxset(0x38, 0x40, 0x40);
...
3715  0442 84            	pop	a
3716                     ; 1038 	hdmirxset(0x1D, 0x08, 0x08); //enable P1 CLKD5 auto reset
...
3797                     ; 1057 	hdmirxset(0xB5, 0x03, 0x03);
...
3811                     ; 1062 		hdmirxset(0x73, 0x08, 0x08);
...
3859  050e 84            	pop	a
3860                     ; 1083 		hdmirxset(REG_RX_0C0, 0x03, 0x00);
...
3868  051b 84            	pop	a
3869                     ; 1084 		hdmirxset(REG_RX_087, 0x01, 0x01);
...
3877  0528 84            	pop	a
3878                     ; 1092 	mhlrxset(0x28, 0x09, CBUSFloatAdj<<3);
...
3952  0552               L7361:
3953                     ; 1115 	case 0 :
3953                     ; 1116 		 hdmirxset(0x0F, 0x03, 0x00);
...
3965  0561               L1461:
3966                     ; 1118 	case 1 :
3966                     ; 1119 		 hdmirxset(0x0F, 0x03, 0x01);
...
3978  0570               L3461:
3979                     ; 1121 	case 2 :
3979                     ; 1122 		 hdmirxset(0x0F, 0x03, 0x02);
...
3991  057f               L5461:
3992                     ; 1124 	case 3:
3992                     ; 1125 		 hdmirxset(0x0F, 0x03, 0x03);
...
4007                     ; 1130 }
4010  058c 87            	retf
4061                     ; 1133 static unsigned char CheckSCDT(struct it6802_dev_data *it6802)
4061                     ; 1134 {
4062                     	switch	.text
...
4176                     ; 1159 static void WaitingForSCDT(struct it6802_dev_data *it6802)
4176                     ; 1160 {
4177                     	switch	.text
...
4294  0640 84            	pop	a
4295                     ; 1209 				hdmirxset(REG_RX_011,(B_P0_DCLKRST|B_P0_CDRRST),0x00);
...
4306  0650               L5771:
4307                     ; 1213 				hdmirxset(REG_RX_018,(B_P1_DCLKRST|B_P1_CDRRST),(B_P1_DCLKRST|B_P1_CDRRST));
...
4315  065c 84            	pop	a
4316                     ; 1214 				hdmirxset(REG_RX_018,(B_P1_DCLKRST|B_P1_CDRRST),0x00);
...
4507                     ; 1266 					 hdmirxset(0xB0, 0x03, 0x03);
...
4656  072e               L7012:
4657                     ; 1307 		return TRUE;
4659  072e a601          	ld	a,#1
4661  0730 2001          	jra	L401
4662  0732               L5012:
4663                     ; 1311 		return FALSE;
4665  0732 4f            	clr	a
4667  0733               L401:
4669  0733 5b03          	addw	sp,#3
4670  0735 87            	retf
4726                     ; 1317 static void SetVideoInputFormatWithInfoFrame(struct it6802_dev_data *it6802)
4726                     ; 1318 {
4727                     	switch	.text
...
4735                     ; 1320 	unsigned char bAVIColorModeIndicated=FALSE;
4737  0738 0f01          	clr	(OFST-1,sp)
4738                     ; 1323 	chgbank(2);
4740  073a ae0002        	ldw	x,#2
4741  073d 8d440544      	callf	L711f_chgbank
4743                     ; 1324 	i=hdmirxrd(REG_RX_215);	//REG_RX_AVI_DB1
...
4754                     ; 1326 	it6802->m_bInputVideoMode &=~F_MODE_CLRMOD_MASK;
4756  074e 1e03          	ldw	x,(OFST+1,sp)
4757  0750 e613          	ld	a,(19,x)
4758  0752 a4fc          	and	a,#252
4759  0754 e713          	ld	(19,x),a
4760                     ; 1329 	switch((i>>O_AVI_COLOR_MODE)&M_AVI_COLOR_MASK)
...
4783  076d               L5112:
4784                     ; 1331 		case B_AVI_COLOR_YUV444:
4784                     ; 1332 			HDMIRX_VIDEO_PRINTF(printf("input YUV444 mode "));
4786  076d ae2bb4        	ldw	x,#L5512
4787  0770 8d000000      	callf	f_printf
4789                     ; 1333 			it6802->m_bInputVideoMode |=F_MODE_YUV444;
...
4798  077e               L7112:
4799                     ; 1335 		case B_AVI_COLOR_YUV422:
4799                     ; 1336 			HDMIRX_VIDEO_PRINTF(printf("input YUV422 mode "));
4801  077e ae2ba1        	ldw	x,#L7512
4802  0781 8d000000      	callf	f_printf
4804                     ; 1337 			it6802->m_bInputVideoMode |=F_MODE_YUV422;
...
4813  078f               L1212:
4814                     ; 1339 		case B_AVI_COLOR_RGB24:
4814                     ; 1340 			HDMIRX_VIDEO_PRINTF(printf("input RGB24 mode "));
4816  078f ae2b8f        	ldw	x,#L1612
4817  0792 8d000000      	callf	f_printf
4819                     ; 1341 			it6802->m_bInputVideoMode |=F_MODE_RGB24;
4821  0796 1e03          	ldw	x,(OFST+1,sp)
4822  0798 e613          	ld	a,(19,x)
4823                     ; 1342 			break;
4825  079a               L3512:
4826                     ; 1348 	HDMIRX_DEBUG_PRINTF(printf("SetVideoInputFormatWithInfoFrame - RegAE=%x it6802->m_bInputVideoMode=%x\r\n",i,it6802->m_bInputVideoMode));
...
4861  07c4 87            	retf
4907                     ; 1355 static void SetColorimetryByInfoFrame(struct it6802_dev_data *it6802)
4907                     ; 1356 {
4908                     	switch	.text
...
4921                     ; 1363 	i=hdmirxrd(REG_RX_216);	//REG_RX_AVI_DB2
...
4950  07f1               L7022:
4951                     ; 1371         else if(i==(B_AVI_CLRMET_ITU709<<O_AVI_CLRMET))
4953  07f1 7b01          	ld	a,(OFST+0,sp)
4954  07f3 a180          	cp	a,#128
4955  07f5 2608          	jrne	L1122
4956                     ; 1373             it6802->m_bInputVideoMode |=F_MODE_ITU709;
...
4967  0801 87            	retf
5004                     ; 1380 static void SetCSCBYPASS(struct it6802_dev_data *it6802)
5004                     ; 1381 {
5005                     	switch	.text
5006  0802               L731f_SetCSCBYPASS:
5010                     ; 1383     it6802->m_bOutputVideoMode=it6802->m_bInputVideoMode;
5012  0802 e613          	ld	a,(19,x)
5013  0804 e712          	ld	(18,x),a
5014                     ; 1385     switch(it6802->m_bInputVideoMode&F_MODE_CLRMOD_MASK) {
...
5027  0815               L5122:
5028                     ; 1386     case F_MODE_RGB24 :
5028                     ; 1387 	hdmirxset(REG_RX_OUT_CSC_CTRL,(M_OUTPUT_COLOR_MASK),B_OUTPUT_RGB24);
...
5040  0824               L7122:
5041                     ; 1389     case F_MODE_YUV422 :
5041                     ; 1390 	hdmirxset(REG_RX_OUT_CSC_CTRL,(M_OUTPUT_COLOR_MASK),B_OUTPUT_YUV422);
...
5053  0833               L1222:
5054                     ; 1392     case F_MODE_YUV444 :
5054                     ; 1393 	hdmirxset(REG_RX_OUT_CSC_CTRL,(M_OUTPUT_COLOR_MASK),B_OUTPUT_YUV444);
...
5066                     ; 1397 }
5069  0840 87            	retf
5132                     ; 1399 static void SetColorSpaceConvert(struct it6802_dev_data *it6802)
5132                     ; 1400 {
5133                     	switch	.text
...
5141                     ; 1403 	unsigned char filter = 0 ; // filter is for Video CTRL DN_FREE_GO, EN_DITHER, and ENUDFILT
5143  0843 0f01          	clr	(OFST-1,sp)
5144                     ; 1412 	HDMIRX_VIDEO_PRINTF(printf("\r\n!!! SetColorSpaceConvert( ) !!!\r\n"));
5146  0845 ae2b20        	ldw	x,#L3232
5147  0848 8d000000      	callf	f_printf
5149                     ; 1415     switch(it6802->m_bOutputVideoMode&F_MODE_CLRMOD_MASK)
...
5165  0863               L221:
5166                     ; 1418     case F_MODE_YUV444:
5166                     ; 1419          HDMIRX_VIDEO_PRINTF(printf("Output mode is YUV444\r\n"));
5168  0863 ae2b08        	ldw	x,#L1332
5169  0866 8d000000      	callf	f_printf
5171                     ; 1420 	    switch(it6802->m_bInputVideoMode&F_MODE_CLRMOD_MASK)
...
5185  087d               L421:
5186                     ; 1422 	    case F_MODE_YUV444:
5186                     ; 1423              HDMIRX_VIDEO_PRINTF(printf("Input mode is YUV444\r\n"));
5188  087d ae2af1        	ldw	x,#L7332
5189  0880 8d000000      	callf	f_printf
5191                     ; 1424 	        csc = B_CSC_BYPASS ;
5193  0884 0f02          	clr	(OFST+0,sp)
5194                     ; 1425 	        break ;
5196  0886 ac830983      	jpf	L7232
5197  088a               L3522:
5198                     ; 1426 	    case F_MODE_YUV422:
5198                     ; 1427              HDMIRX_VIDEO_PRINTF(printf("Input mode is YUV422\r\n"));
5200  088a ae2ada        	ldw	x,#L1432
5201  088d 8d000000      	callf	f_printf
5203                     ; 1428             csc = B_CSC_BYPASS ;
5205  0891 0f02          	clr	(OFST+0,sp)
5206                     ; 1429             if(it6802->m_bOutputVideoMode & F_MODE_EN_UDFILT)// RGB24 to YUV422 need up/dn filter.
5208  0893 1e03          	ldw	x,(OFST+1,sp)
5209  0895 e612          	ld	a,(18,x)
5210  0897 a540          	bcp	a,#64
5211  0899 2706          	jreq	L3432
5212                     ; 1431                 filter |= B_RX_EN_UDFILTER ;
5214  089b 7b01          	ld	a,(OFST-1,sp)
5215  089d aa01          	or	a,#1
5216  089f 6b01          	ld	(OFST-1,sp),a
5217  08a1               L3432:
5218                     ; 1434             if(it6802->m_bOutputVideoMode & F_MODE_EN_DITHER)// RGB24 to YUV422 need up/dn filter.
...
5249  08ca               L7522:
5250                     ; 1450     case F_MODE_YUV422:
5250                     ; 1451 	    switch(it6802->m_bInputVideoMode&F_MODE_CLRMOD_MASK)
...
5338  092e               L7622:
5339                     ; 1487     case F_MODE_RGB24:
5339                     ; 1488          HDMIRX_VIDEO_PRINTF(printf("Output mode is RGB24\r\n"));
5341  092e ae2aac        	ldw	x,#L3632
5342  0931 8d000000      	callf	f_printf
5344                     ; 1489 	    switch(it6802->m_bInputVideoMode&F_MODE_CLRMOD_MASK)
...
5464  09c3               L3042:
5465                     ; 1534                 HDMIRX_VIDEO_PRINTF(printf(" 0-255\r\n"));
5467  09c3 ae2a91        	ldw	x,#L1142
5468  09c6 8d000000      	callf	f_printf
5470                     ; 1535 		chgbank(1);	//for CSC setting Reg170 ~ Reg184 !!!!
5472  09ca ae0001        	ldw	x,#1
5473  09cd 8d440544      	callf	L711f_chgbank
5475                     ; 1536                 hdmirxbwr(REG_RX_170,sizeof(bCSCMtx_RGB2YUV_ITU709_0_255),bCSCMtx_RGB2YUV_ITU709_0_255);
...
5486  09e2               L7732:
5487                     ; 1541             HDMIRX_VIDEO_PRINTF(printf("ITU601 "));
5489  09e2 ae2a89        	ldw	x,#L5142
5490  09e5 8d000000      	callf	f_printf
5492                     ; 1542             if(it6802->m_bInputVideoMode & F_MODE_16_235)
5494  09e9 1e03          	ldw	x,(OFST+1,sp)
5495  09eb e613          	ld	a,(19,x)
5496  09ed a520          	bcp	a,#32
5497  09ef 271f          	jreq	L7142
5498                     ; 1544 		chgbank(1);	//for CSC setting Reg170 ~ Reg184 !!!!
5500  09f1 ae0001        	ldw	x,#1
5501  09f4 8d440544      	callf	L711f_chgbank
5503                     ; 1545                 hdmirxbwr(REG_RX_170,sizeof(bCSCMtx_RGB2YUV_ITU601_16_235),bCSCMtx_RGB2YUV_ITU601_16_235);
...
5512  0a06 85            	popw	x
5513                     ; 1546                 HDMIRX_VIDEO_PRINTF(printf(" 16-235\r\n"));
5515  0a07 ae2a9a        	ldw	x,#L5042
5516  0a0a 8d000000      	callf	f_printf
5519  0a0e 201d          	jra	L5732
5520  0a10               L7142:
5521                     ; 1550 		chgbank(1);	//for CSC setting Reg170 ~ Reg184 !!!!
5523  0a10 ae0001        	ldw	x,#1
5524  0a13 8d440544      	callf	L711f_chgbank
5526                     ; 1551                 hdmirxbwr(REG_RX_170,sizeof(bCSCMtx_RGB2YUV_ITU601_0_255),bCSCMtx_RGB2YUV_ITU601_0_255);
...
5593  0a74               L1342:
5594                     ; 1572                 HDMIRX_VIDEO_PRINTF(printf("0-255\r\n"));
5596  0a74 ae2a69        	ldw	x,#L7342
5597  0a77 8d000000      	callf	f_printf
5599                     ; 1573 		chgbank(1);	//for CSC setting Reg170 ~ Reg184 !!!!
5601  0a7b ae0001        	ldw	x,#1
5602  0a7e 8d440544      	callf	L711f_chgbank
5604                     ; 1574                 hdmirxbwr(REG_RX_170,sizeof(bCSCMtx_YUV2RGB_ITU709_0_255),bCSCMtx_YUV2RGB_ITU709_0_255);
...
5649  0ac1               L3442:
5650                     ; 1588                 HDMIRX_VIDEO_PRINTF(printf("0-255\r\n"));
5652  0ac1 ae2a69        	ldw	x,#L7342
5653  0ac4 8d000000      	callf	f_printf
5655                     ; 1589 		chgbank(1);	//for CSC setting Reg170 ~ Reg184 !!!!
5657  0ac8 ae0001        	ldw	x,#1
5658  0acb 8d440544      	callf	L711f_chgbank
5660                     ; 1590                 hdmirxbwr(REG_RX_170,sizeof(bCSCMtx_YUV2RGB_ITU601_0_255),bCSCMtx_YUV2RGB_ITU601_0_255);
...
5676                     ; 1601     	hdmirxset(REG_RX_OUT_CSC_CTRL,(M_CSC_SEL_MASK),csc);
...
5685  0af0 84            	pop	a
5686                     ; 1604 	hdmirxset(REG_RX_VIDEO_CTRL1,(B_RX_DNFREE_GO|B_RX_EN_DITHER|B_RX_EN_UDFILTER),filter);
...
5878  0b4f               L1742:
5879                     ; 1634     case F_MODE_YUV444:
5879                     ; 1635 	i |=B_INPUT_YUV444;
5881  0b4f 7b01          	ld	a,(OFST+0,sp)
5882  0b51 aa02          	or	a,#2
5883  0b53 6b01          	ld	(OFST+0,sp),a
5884                     ; 1636 	it6802->m_bInputVideoMode |=F_MODE_YUV444;
...
5893  0b5f               L3742:
5894                     ; 1638     case F_MODE_YUV422:
5894                     ; 1639 	i |=B_INPUT_YUV422;
5896  0b5f 7b01          	ld	a,(OFST+0,sp)
5897  0b61 aa01          	or	a,#1
5898  0b63 6b01          	ld	(OFST+0,sp),a
5899                     ; 1640         it6802->m_bInputVideoMode |=F_MODE_YUV422;
...
5908  0b6f               L5742:
5909                     ; 1642     case F_MODE_RGB24:
5909                     ; 1643 	i |=B_INPUT_RGB24;
5911                     ; 1644         it6802->m_bInputVideoMode |=F_MODE_RGB24;
5913  0b6f 1e02          	ldw	x,(OFST+1,sp)
5914  0b71 e613          	ld	a,(19,x)
5915                     ; 1645         break;
5917  0b73               L7252:
5918                     ; 1649     mhlrxwr(REG_RX_IN_CSC_CTRL,i);
...
5931  0b7f 87            	retf
5977                     ; 1653 static void SetColorimetryByMode(struct it6802_dev_data *it6802)
5977                     ; 1654 {
5978                     	switch	.text
...
6019  0bad               L5552:
6020                     ; 1670         it6802->m_bInputVideoMode &=~F_MODE_ITU709;
...
6169                     ; 1694 	it6802->m_bOutputVideoMode = HDMIRX_OUTPUT_VID_MODE ;
6171  0bdf a640          	ld	a,#64
6172  0be1 e712          	ld	(18,x),a
6173                     ; 1696 	it6802->m_bUpHDMIMode =IsHDMIMode();
...
6221                     ; 1710 	switch( it6802->GCP_CD ) {
...
6232                     ; 1721 	hdmirxset(0x65, 0x0C, 0x00);
...
6245                     ; 1713 	hdmirxset(0x65, 0x0C, 0x04);
...
6258                     ; 1717 	hdmirxset(0x65, 0x0C, 0x08);
...
6311  0c88               L7462:
6312                     ; 1749 	hdmirxset(REG_RX_051,(B_HALF_CLK|B_OUT_DDR),0x00);	// for output  single Pixel mode
...
6326  0c97 87            	retf
6364                     ; 1756 static void SetVideoOutputColorFormat(struct it6802_dev_data *it6802)
6364                     ; 1757 {
6365                     	switch	.text
6366  0c98               L551f_SetVideoOutputColorFormat:
6370                     ; 1758 	switch(it6802->m_bOutputVideoMode&F_MODE_CLRMOD_MASK) {
...
6383  0ca7               L3562:
6384                     ; 1759 		case F_MODE_RGB24 :
6384                     ; 1760 			hdmirxset(REG_RX_OUT_CSC_CTRL,(M_OUTPUT_COLOR_MASK),B_OUTPUT_RGB24);
...
6396  0cb6               L5562:
6397                     ; 1762 		case F_MODE_YUV422 :
6397                     ; 1763 			hdmirxset(REG_RX_OUT_CSC_CTRL,(M_OUTPUT_COLOR_MASK),B_OUTPUT_YUV422);
...
6409  0cc5               L7562:
6410                     ; 1765 		case F_MODE_YUV444 :
6410                     ; 1766 			hdmirxset(REG_RX_OUT_CSC_CTRL,(M_OUTPUT_COLOR_MASK),B_OUTPUT_YUV444);
...
6422                     ; 1769 }
6425  0cd2 87            	retf
6471                     ; 1771 void it6802PortSelect(unsigned char ucPortSel)
6471                     ; 1772 {
6472                     	switch	.text
6473  0cd3               f_it6802PortSelect:
6475  0cd3 89            	pushw	x
6476       00000002      OFST:	set	2
6479                     ; 1773 	struct it6802_dev_data *it6802data = get_it6802_dev_data();
6481  0cd4 8d030203      	callf	L501f_get_it6802_dev_data
6483  0cd8 1f01          	ldw	(OFST-1,sp),x
6484                     ; 1783 	hdmirxset(REG_RX_051, B_PORT_SEL, F_PORT_SEL_0); //select port 0
...
6492  0ce6 84            	pop	a
6493                     ; 1784 	it6802data->m_ucCurrentHDMIPort = F_PORT_SEL_0;
6495  0ce7 1e01          	ldw	x,(OFST-1,sp)
6496  0ce9 6f11          	clr	(17,x)
6497                     ; 1787 	IT6802SwitchVideoState(it6802data,VSTATE_SyncWait);
...
6507  0cf4 85            	popw	x
6508  0cf5 87            	retf
6531                     ; 1798 static void aud_fiforst( void )
6531                     ; 1799 {
6532                     	switch	.text
6533  0cf6               L751f_aud_fiforst:
6537                     ; 1800 	hdmirxset(REG_RX_010, 0x02, 0x02);
...
6545  0d02 84            	pop	a
6546                     ; 1801 	hdmirxset(REG_RX_010, 0x02, 0x00);
...
6555                     ; 1802 }
6558  0d10 87            	retf
6591                     ; 1805 static void IT6802AudioOutputEnable(unsigned char bEnable)
6591                     ; 1806 {
6592                     	switch	.text
6593  0d11               L161f_IT6802AudioOutputEnable:
6597                     ; 1807 	if(bEnable==TRUE)
6599  0d11 a101          	cp	a,#1
6600  0d13 260f          	jrne	L3572
6601                     ; 1809 		hdmirxset(REG_RX_052,(B_TriI2SIO|B_TriSPDIF),0x00);
...
6612  0d24               L3572:
6613                     ; 1813 		hdmirxset(REG_RX_052,(B_TriI2SIO|B_TriSPDIF),(B_TriI2SIO|B_TriSPDIF));
...
6623                     ; 1815 }
6626  0d31 87            	retf
6649                     ; 1819 static void hdmirx_ResetAudio(void)
6649                     ; 1820 {
6650                     	switch	.text
6651  0d32               L361f_hdmirx_ResetAudio:
6655                     ; 1821 	hdmirxset(REG_RX_RST_CTRL,B_AUDRST,B_AUDRST);
...
6663  0d3e 84            	pop	a
6664                     ; 1822 	hdmirxset(REG_RX_RST_CTRL,B_AUDRST,0x00);
...
6673                     ; 1823 }
6676  0d4c 87            	retf
6700                     ; 1826 static void hdmirx_SetHWMuteClrMode(void)
6700                     ; 1827 {
6701                     	switch	.text
6702  0d4d               L561f_hdmirx_SetHWMuteClrMode:
6706                     ; 1828     hdmirxset(REG_RX_HWMuteCtrl,(B_HWAudMuteClrMode),(B_HWAudMuteClrMode));
...
6715                     ; 1829 }
6718  0d5a 87            	retf
6742                     ; 1831 static void hdmirx_SetHWMuteClr(void)
6742                     ; 1832 {
6743                     	switch	.text
6744  0d5b               L761f_hdmirx_SetHWMuteClr:
6748                     ; 1833     hdmirxset(REG_RX_HWMuteCtrl,(B_HWMuteClr),(B_HWMuteClr));
...
6757                     ; 1834 }
6760  0d68 87            	retf
6784                     ; 1836 static void hdmirx_ClearHWMuteClr(void)
6784                     ; 1837 {
6785                     	switch	.text
6786  0d69               L171f_hdmirx_ClearHWMuteClr:
6790                     ; 1838     hdmirxset(REG_RX_HWMuteCtrl,(B_HWMuteClr),0);
...
6799                     ; 1839 }
6802  0d76 87            	retf
6847                     ; 1844 static void getHDMIRXInputAudio(AUDIO_CAPS *pAudioCaps)
6847                     ; 1845 {
6848                     	switch	.text
...
6922  0dca 87            	retf
6975                     ; 1872 static void IT6802SwitchAudioState(struct it6802_dev_data *it6802,Audio_State_Type state)
6975                     ; 1873 {
6976                     	switch	.text
6977  0dcb               L571f_IT6802SwitchAudioState:
6979  0dcb 89            	pushw	x
6980       00000000      OFST:	set	0
6983                     ; 1876 	if( it6802->m_AState == state )
6985  0dcc e601          	ld	a,(1,x)
6986  0dce 1106          	cp	a,(OFST+6,sp)
6987  0dd0 2604ac530e53  	jreq	L671
6988                     ; 1878 	    return ;
6990                     ; 1881 	HDMIRX_AUDIO_PRINTF(printf(AStateStr[(unsigned char)state]));
...
7024  0e02               L5403:
7025                     ; 1889 	case ASTATE_AudioOff:
7025                     ; 1890 		hdmirxset(REG_RX_RST_CTRL, B_AUDRST, B_AUDRST);
...
7033  0e0e 84            	pop	a
7034                     ; 1891 		IT6802AudioOutputEnable(OFF);
7036  0e0f 4f            	clr	a
7037  0e10 8d110d11      	callf	L161f_IT6802AudioOutputEnable
7039                     ; 1893 		break;
7041  0e14 203d          	jra	L7013
7042  0e16               L7403:
7043                     ; 1894 	case ASTATE_RequestAudio:
7043                     ; 1895 		IT6802AudioOutputEnable(OFF);
7045  0e16 4f            	clr	a
7046  0e17 8d110d11      	callf	L161f_IT6802AudioOutputEnable
7048                     ; 1897 	    break;
7050  0e1b 2036          	jra	L7013
7051  0e1d               L1503:
7052                     ; 1899 	case ASTATE_WaitForReady:
7052                     ; 1900 		hdmirx_SetHWMuteClr();
7054  0e1d 8d5b0d5b      	callf	L761f_hdmirx_SetHWMuteClr
7056                     ; 1901 		hdmirx_ClearHWMuteClr();
7058  0e21 8d690d69      	callf	L171f_hdmirx_ClearHWMuteClr
7060                     ; 1902 		it6802->m_AudioCountingTimer = AUDIO_READY_TIMEOUT;
...
7068  0e2f               L3503:
7069                     ; 1905 	case ASTATE_AudioOn:
7069                     ; 1906 
7069                     ; 1907 		IT6802AudioOutputEnable(ON);
7071  0e2f a601          	ld	a,#1
7072  0e31 8d110d11      	callf	L161f_IT6802AudioOutputEnable
7074                     ; 1909 		HDMIRX_AUDIO_PRINTF(printf("Cat6023 Audio--> Audio flag=%02X,Ch No=%02X,Fs=%02X ... \r\n",
7074                     ; 1910                         		(int)it6802->m_RxAudioCaps.AudioFlag,
7074                     ; 1911                         		(int)it6802->m_RxAudioCaps.AudSrcEnable,
7074                     ; 1912                         		(int)it6802->m_RxAudioCaps.SampleFreq));
...
7102  0e53 85            	popw	x
7103  0e54 87            	retf
7155                     ; 1917 static void IT6802AudioHandler(struct it6802_dev_data *it6802)
7155                     ; 1918 {
7156                     	switch	.text
...
7178  0e6f               L5413:
7179                     ; 1927    it6802->m_AudioCountingTimer = 0;
7181  0e6f 1e09          	ldw	x,(OFST+1,sp)
7182  0e71 905f          	clrw	y
7183  0e73 ef0f          	ldw	(15,x),y
7184  0e75               L7413:
7185                     ; 1931    if(it6802->m_RxHDCPState==RxHDCP_ModeCheck)
...
7192  0e81               L402:
7193                     ; 1932    	return;
7195                     ; 1934     switch(it6802->m_AState)
...
7210  0e9b               L3113:
7211                     ; 1936     case ASTATE_RequestAudio:
7211                     ; 1937 
7211                     ; 1938         getHDMIRXInputAudio(&(it6802->m_RxAudioCaps));
7213  0e9b 1e09          	ldw	x,(OFST+1,sp)
7214  0e9d 1c0003        	addw	x,#3
7215  0ea0 8d770d77      	callf	L371f_getHDMIRXInputAudio
7217                     ; 1940         if(it6802->m_RxAudioCaps.AudioFlag & B_CAP_AUDIO_ON)
...
7224  0eb0               L012:
7225                     ; 1943 		hdmirxset(REG_RX_MCLK_CTRL,M_MCLKSel,B_256FS);
...
7233  0ebc 84            	pop	a
7234                     ; 1945             if(it6802->m_RxAudioCaps.AudioFlag& B_CAP_HBR_AUDIO)
7236  0ebd 1e09          	ldw	x,(OFST+1,sp)
7237  0ebf e603          	ld	a,(3,x)
7238  0ec1 a540          	bcp	a,#64
7239  0ec3 271e          	jreq	L1613
7240                     ; 1947 		HDMIRX_AUDIO_PRINTF(printf("+++++++++++ B_CAP_HBR_AUDIO +++++++++++++++++\r\n"));
7242  0ec5 ae2993        	ldw	x,#L3613
7243  0ec8 8d000000      	callf	f_printf
7245                     ; 1949 		hdmirxset(REG_RX_MCLK_CTRL,M_MCLKSel,B_128FS);	// MCLK = 128fs only for HBR audio
...
7290  0f01 84            	pop	a
7291                     ; 1964 		hdmirx_SetHWMuteClrMode();
7293  0f02 8d4d0d4d      	callf	L561f_hdmirx_SetHWMuteClrMode
7295                     ; 1965 		hdmirx_ResetAudio();
7297  0f06 8d320d32      	callf	L361f_hdmirx_ResetAudio
7299  0f0a               L5613:
7300                     ; 1969             IT6802SwitchAudioState(it6802,ASTATE_WaitForReady);
...
7308  0f15               L5113:
7309                     ; 1974     case ASTATE_WaitForReady:
7309                     ; 1975 
7309                     ; 1976 	//if(AudioTimeOutCheck(AUDIO_READY_TIMEOUT))
7309                     ; 1977 	if(it6802->m_AudioCountingTimer==0)
7311  0f15 1e09          	ldw	x,(OFST+1,sp)
7312  0f17 e610          	ld	a,(16,x)
7313  0f19 ea0f          	or	a,(15,x)
7314  0f1b 2644          	jrne	L5513
7315                     ; 1979             IT6802SwitchAudioState(it6802,ASTATE_AudioOn);
...
7323  0f28               L7113:
7324                     ; 1983     case ASTATE_AudioOn:
7324                     ; 1984 	//if(AudioTimeOutCheck(AUDIO_MONITOR_TIMEOUT)==TRUE)
7324                     ; 1985 	if(it6802->m_AudioCountingTimer==0)
7326  0f28 1e09          	ldw	x,(OFST+1,sp)
7327  0f2a e610          	ld	a,(16,x)
7328  0f2c ea0f          	or	a,(15,x)
7329  0f2e 2631          	jrne	L5513
7330                     ; 1990 		it6802->m_AudioCountingTimer = AUDIO_MONITOR_TIMEOUT;
7332  0f30 1e09          	ldw	x,(OFST+1,sp)
7333  0f32 90ae0097      	ldw	y,#151
7334  0f36 ef0f          	ldw	(15,x),y
7335                     ; 1992 		getHDMIRXInputAudio(&CurAudioCaps);
7337  0f38 96            	ldw	x,sp
7338  0f39 1c0001        	addw	x,#OFST-7
7339  0f3c 8d770d77      	callf	L371f_getHDMIRXInputAudio
7341                     ; 1994 	        if(it6802->m_RxAudioCaps.AudioFlag != CurAudioCaps.AudioFlag
7341                     ; 1995 	           || it6802->m_RxAudioCaps.AudSrcEnable != CurAudioCaps.AudSrcEnable
7341                     ; 1996 	           || it6802->m_RxAudioCaps.SampleFreq != CurAudioCaps.SampleFreq)
...
7357  0f58               L1023:
7358                     ; 1999 			IT6802SwitchAudioState(it6802,ASTATE_RequestAudio);
...
7371  0f63 87            	retf
7406                     ; 2014 static void IT6802_AFE_Rst( void )
7406                     ; 2015 {
7407                     	switch	.text
...
7455  0f9b               L1223:
7456                     ; 2026 		hdmirxset(0x18, 0x0C, 0x0C);
...
7483  0fbc 84            	pop	a
7484  0fbd 87            	retf
7530                     ; 2032 static void IT6802_SetVideoMute(struct it6802_dev_data *it6802,unsigned char bMute)
7530                     ; 2033 {
7531                     	switch	.text
...
7542                     ; 2038 	hdmirxset(REG_RX_053,(B_VDGatting|B_VIOSel),(B_VDGatting|B_VIOSel));	//Reg53[7][5] = 11    // for enable B_VDIO_GATTING and VIO_SEL
...
7550  0fcf 84            	pop	a
7551                     ; 2039 	hdmirxset(REG_RX_052,(B_DisVAutoMute),(B_DisVAutoMute));				//Reg52[5] = 1 for disable Auto video MUTE
...
7559  0fdc 84            	pop	a
7560                     ; 2040 	hdmirxset(REG_RX_053,(B_TriVDIO),(0x00));								//Reg53[2:0] = 000;         // 0 for enable video io data output
...
7571  0fec               L7423:
7572                     ; 2044         if(it6802->m_VState == VSTATE_VideoOn)
7574  0fec 1e01          	ldw	x,(OFST+1,sp)
7575  0fee f6            	ld	a,(x)
7576  0fef a10a          	cp	a,#10
7577  0ff1 2665          	jrne	L1523
7578                     ; 2047 		hdmirxset(REG_RX_053,(B_TriSYNC),(0x00));								//Reg53[0] = 0;                 // for enable video sync
...
7586  0fff 84            	pop	a
7587                     ; 2048 		hdmirxset(REG_RX_053,(B_TriVDIO),(0x00));								//Reg53[3:1] = 000;         // 0 for enable video io data output
...
7595  100c 84            	pop	a
7596                     ; 2050             if(CheckAVMute()==TRUE)
7598  100d 8d6d066d      	callf	L521f_CheckAVMute
7600  1011 a101          	cp	a,#1
7601  1013 260f          	jrne	L5523
7602                     ; 2052 		hdmirxset(REG_RX_052,(B_DisVAutoMute),(B_DisVAutoMute));				//Reg52[5] = 1 for disable Auto video MUTE
...
7613  1024               L5523:
7614                     ; 2057 		hdmirxset(REG_RX_053,(B_TriVDIO),(B_TriVDIO));							//Reg53[2:0] = 111;         // 1 for enable tri-state of video io data
...
7622  1030 84            	pop	a
7623                     ; 2058 		hdmirxset(REG_RX_053,(B_TriVDIO),(0x00));								//Reg53[2:0] = 000;         // 0 for enable video io data output
...
7631  103d 84            	pop	a
7632                     ; 2060 		hdmirxset(REG_RX_053,(B_VDGatting|B_VIOSel),(B_VDGatting|B_VIOSel));	//Reg53[7][5] = 11    // for enable B_VDIO_GATTING and VIO_SEL
...
7640  104a 84            	pop	a
7641                     ; 2061 		hdmirxset(REG_RX_053,(B_VDGatting|B_VIOSel),(B_VIOSel));				//Reg53[7][5] = 01    // for disable B_VDIO_GATTING
...
7654  1058 85            	popw	x
7655  1059 87            	retf
7688                     ; 2096 static void IT6802VideoOutputEnable(unsigned char bEnableOutput)
7688                     ; 2097 {
7689                     	switch	.text
7690  105a               L502f_IT6802VideoOutputEnable:
7694                     ; 2098 	if(bEnableOutput)
7696  105a 4d            	tnz	a
7697  105b 270f          	jreq	L5723
7698                     ; 2101 		hdmirxset(REG_RX_053,(B_TriSYNC|B_TriVDIO),(0x00));
...
7709  106c               L5723:
7710                     ; 2107 		hdmirxset(REG_RX_053,(B_TriSYNC|B_TriVDIO),(B_TriSYNC|B_TriVDIO));
...
7720                     ; 2109 }
7723  1079 87            	retf
7779                     ; 2113 static void IT6802SwitchVideoState(struct it6802_dev_data *it6802,Video_State_Type  eNewVState)
7779                     ; 2114 {
7780                     	switch	.text
7781  107a               L702f_IT6802SwitchVideoState:
7783  107a 89            	pushw	x
7784       00000000      OFST:	set	0
7787                     ; 2116 	if(it6802->m_VState==eNewVState)
7789  107b f6            	ld	a,(x)
7790  107c 1106          	cp	a,(OFST+6,sp)
7791  107e 2604ac011101  	jreq	L222
7792                     ; 2117 		return;
7794                     ; 2119 	HDMIRX_VIDEO_PRINTF(printf(VStateStr[(unsigned char)eNewVState]));
...
8070  1185 85            	popw	x
8071  1186 87            	retf
8126                     ; 2268 static void hdmirx_INT_5V_Pwr_Chg(struct it6802_dev_data *it6802,unsigned char ucport)
8126                     ; 2269 {
8127                     	switch	.text
...
8168  11b4               L1443:
8169                     ; 2281 			MHLRX_DEBUG_PRINTF(printf("#### Power 5V OFF ####\r\n"));
8171  11b4 ae2962        	ldw	x,#L7443
8172  11b7 8d000000      	callf	f_printf
8174                     ; 2282 			IT6802SwitchVideoState(it6802,VSTATE_SWReset);
...
8186  11c6 87            	retf
8224                     ; 2289 static void hdmirx_INT_P0_ECC(struct it6802_dev_data *it6802)
8224                     ; 2290 {
8225                     	switch	.text
8226  11c7               L512f_hdmirx_INT_P0_ECC:
8230                     ; 2291 	if((it6802->m_ucEccCount_P0++) > ECC_TIMEOUT)
8232  11c7 e615          	ld	a,(21,x)
8233  11c9 6c15          	inc	(21,x)
8234  11cb a12a          	cp	a,#42
8235  11cd 2523          	jrult	L1743
8236                     ; 2293 		it6802->m_ucEccCount_P0=0;
8238  11cf 6f15          	clr	(21,x)
8239                     ; 2295 		MHLRX_DEBUG_PRINTF(printf("CDR reset for Port0 ECC_TIMEOUT !!!\r\n"));
8241  11d1 ae293c        	ldw	x,#L3743
8242  11d4 8d000000      	callf	f_printf
8244                     ; 2297 		hdmirxset(REG_RX_011,(B_P0_DCLKRST|B_P0_CDRRST),(B_P0_DCLKRST|B_P0_CDRRST));
...
8252  11e4 84            	pop	a
8253                     ; 2298 		hdmirxset(REG_RX_011,(B_P0_DCLKRST|B_P0_CDRRST),0x00);
...
8263                     ; 2301 }
8266  11f2 87            	retf
8304                     ; 2304 static void hdmirx_INT_P1_ECC(struct it6802_dev_data *it6802)
8304                     ; 2305 {
8305                     	switch	.text
8306  11f3               L712f_hdmirx_INT_P1_ECC:
8310                     ; 2306 	if((it6802->m_ucEccCount_P1++) > ECC_TIMEOUT)
8312  11f3 e616          	ld	a,(22,x)
8313  11f5 6c16          	inc	(22,x)
8314  11f7 a12a          	cp	a,#42
8315  11f9 2523          	jrult	L5153
8316                     ; 2308 		it6802->m_ucEccCount_P1=0;
8318  11fb 6f16          	clr	(22,x)
8319                     ; 2310 		MHLRX_DEBUG_PRINTF(printf("CDR reset for Port1 ECC_TIMEOUT !!!\r\n"));
8321  11fd ae2916        	ldw	x,#L7153
8322  1200 8d000000      	callf	f_printf
8324                     ; 2312 		hdmirxset(REG_RX_018,(B_P1_DCLKRST|B_P1_CDRRST),(B_P1_DCLKRST|B_P1_CDRRST));
...
8332  1210 84            	pop	a
8333                     ; 2313 		hdmirxset(REG_RX_018,(B_P1_DCLKRST|B_P1_CDRRST),0x00);
...
8343                     ; 2315 }
8346  121e 87            	retf
8385                     ; 2318 static void hdmirx_INT_P0_Deskew(struct it6802_dev_data *it6802)
8385                     ; 2319 {
8386                     	switch	.text
8387  121f               L122f_hdmirx_INT_P0_Deskew:
8391                     ; 2320 	if((it6802->m_ucDeskew_P0++) > DESKEW_TIMEOUT)
8393  121f e617          	ld	a,(23,x)
8394  1221 6c17          	inc	(23,x)
8395  1223 a12a          	cp	a,#42
8396  1225 2523          	jrult	L1453
8397                     ; 2322 		it6802->m_ucDeskew_P0=0;
8399  1227 6f17          	clr	(23,x)
8400                     ; 2324 		MHLRX_DEBUG_PRINTF(printf("CDR reset for Port0 DESKEW_TIMEOUT !!!\r\n"));
8402  1229 ae28ed        	ldw	x,#L3453
8403  122c 8d000000      	callf	f_printf
8405                     ; 2326 		hdmirxset(REG_RX_011,(B_P0_DCLKRST|B_P0_CDRRST),(B_P0_DCLKRST|B_P0_CDRRST));
...
8413  123c 84            	pop	a
8414                     ; 2327 		hdmirxset(REG_RX_011,(B_P0_DCLKRST|B_P0_CDRRST),0x00);
...
8424                     ; 2330 }
8427  124a 87            	retf
8466                     ; 2333 static void hdmirx_INT_P1_Deskew(struct it6802_dev_data *it6802)
8466                     ; 2334 {
8467                     	switch	.text
8468  124b               L322f_hdmirx_INT_P1_Deskew:
8472                     ; 2335 	if((it6802->m_ucDeskew_P1++) > DESKEW_TIMEOUT)
8474  124b e618          	ld	a,(24,x)
8475  124d 6c18          	inc	(24,x)
8476  124f a12a          	cp	a,#42
8477  1251 2523          	jrult	L5653
8478                     ; 2337 		it6802->m_ucDeskew_P1=0;
8480  1253 6f18          	clr	(24,x)
8481                     ; 2339 		MHLRX_DEBUG_PRINTF(printf("CDR reset for Port1 DESKEW_TIMEOUT !!!\r\n"));
8483  1255 ae28c4        	ldw	x,#L7653
8484  1258 8d000000      	callf	f_printf
8486                     ; 2341 		hdmirxset(REG_RX_018,(B_P1_DCLKRST|B_P1_CDRRST),(B_P1_DCLKRST|B_P1_CDRRST));
...
8494  1268 84            	pop	a
8495                     ; 2342 		hdmirxset(REG_RX_018,(B_P1_DCLKRST|B_P1_CDRRST),0x00);
...
8725  1303 85            	popw	x
8726  1304 87            	retf
8935                     ; 2393 static void hdcpsts( void )
8935                     ; 2394 {
8936                     	switch	.text
...
9172                     ; 2432 	MHLRX_DEBUG_PRINTF(printf("AKSV = 0x%X%X%X%X%X%X%X%X%X%X \r\n", AKSV5>>4, AKSV5&0x0F,
9172                     ; 2433 		                                       AKSV4>>4, AKSV4&0x0F,
9172                     ; 2434 											   AKSV3>>4, AKSV3&0x0F,
9172                     ; 2435 											   AKSV2>>4, AKSV2&0x0F,
9172                     ; 2436 											   AKSV1>>4, AKSV1&0x0F));
...
9263                     ; 2438 	MHLRX_DEBUG_PRINTF(printf("BKSV = 0x%X%X%X%X%X%X%X%X%X%X \r\n", BKSV5>>4, BKSV5&0x0F,
9263                     ; 2439 		                                       BKSV4>>4, BKSV4&0x0F,
9263                     ; 2440 											   BKSV3>>4, BKSV3&0x0F,
9263                     ; 2441 											   BKSV2>>4, BKSV2&0x0F,
9263                     ; 2442 											   BKSV1>>4, BKSV1&0x0F));
...
9354                     ; 2444 	MHLRX_DEBUG_PRINTF(printf("M0   = 0x%X%X%X%X%X%X%X%X%X%X%X%X%X%X%X%X \r\n", Mi8>>4, Mi8&0x0F,
9354                     ; 2445 		                                                   Mi7>>4, Mi7&0x0F,
9354                     ; 2446 														   Mi6>>4, Mi6&0x0F,
9354                     ; 2447 														   Mi5>>4, Mi5&0x0F,
9354                     ; 2448 														   Mi4>>4, Mi4&0x0F,
9354                     ; 2449 														   Mi3>>4, Mi3&0x0F,
9354                     ; 2450 														   Mi2>>4, Mi2&0x0F,
9354                     ; 2451 														   Mi1>>4, Mi1&0x0F));
...
9505  15a4 87            	retf
9544                     ; 2468 static void parse_rcpkey( unsigned char rcpkey )
9544                     ; 2469 {
9545                     	switch	.text
...
9553                     ; 2472      suppkey = TRUE;
9555  15a7 a601          	ld	a,#1
9556  15a9 6b01          	ld	(OFST+0,sp),a
9557                     ; 2474      MHLRX_DEBUG_PRINTF(printf("KeyCode=%x ==>", rcpkey&0x7F));
...
9569  15bb 85            	popw	x
9570                     ; 2476      switch( rcpkey&0x7F ) {
9572  15bc 7b02          	ld	a,(OFST+1,sp)
9573  15be a47f          	and	a,#127
9575                     ; 2549      default  : MHLRX_DEBUG_PRINTF(printf("ERROR: Reserved RCP sub-command code !!!\r\n")); suppkey = FALSE;
...
10335  19a8 87            	retf
10376                     ; 2566 static void mhl_parse_RCPkey(struct it6802_dev_data *it6802)
10376                     ; 2567 {
10377                     	switch	.text
10378  19a9               L532f_mhl_parse_RCPkey:
10380  19a9 89            	pushw	x
10381       00000000      OFST:	set	0
10384                     ; 2568 	parse_rcpkey( it6802->rxmsgdata[1]);
10386  19aa e64b          	ld	a,(75,x)
10387  19ac 8da515a5      	callf	L332f_parse_rcpkey
10389                     ; 2570 	if( SuppRCPCode[it6802->rxmsgdata[1]] ){
...
10397                     ; 2572 		it6802->txmsgdata[0] = MSG_RCPK;
10399  19bc 1e01          	ldw	x,(OFST+1,sp)
10400  19be a611          	ld	a,#17
10401  19c0 e748          	ld	(72,x),a
10402                     ; 2573 		it6802->txmsgdata[1] = it6802->rxmsgdata[1];
10404  19c2 1e01          	ldw	x,(OFST+1,sp)
10405  19c4 e64b          	ld	a,(75,x)
10406  19c6 e749          	ld	(73,x),a
10407                     ; 2574 		MHL_MSC_DEBUG_PRINTF(printf("Send a RCPK with action code = 0x%02X\r\n", it6802->txmsgdata[1]));
...
10437  19ef 84            	pop	a
10438  19f0               L7444:
10439                     ; 2586 	cbus_send_mscmsg(it6802);
10441  19f0 1e01          	ldw	x,(OFST+1,sp)
10442  19f2 8d661c66      	callf	L352f_cbus_send_mscmsg
10444                     ; 2587 	SwitchRCPResult(it6802,RCP_Result_Finish);
...
10455  1a00 87            	retf
10495                     ; 2594 static void mhl_parse_RAPkey(struct it6802_dev_data *it6802)
10495                     ; 2595 {
10496                     	switch	.text
10497  1a01               L732f_mhl_parse_RAPkey:
10499  1a01 89            	pushw	x
10500       00000000      OFST:	set	0
10503                     ; 2598 	it6802->txmsgdata[0] = MSG_RAPK;
10505  1a02 a621          	ld	a,#33
10506  1a04 e748          	ld	(72,x),a
10507                     ; 2600 	if( SuppRAPCode[it6802->rxmsgdata[1]]) {
...
10540                     ; 2619 		default  :
10540                     ; 2620 
10540                     ; 2621 		it6802->txmsgdata[1] = 0x01;
10542  1a2a 1e01          	ldw	x,(OFST+1,sp)
10543  1a2c a601          	ld	a,#1
10544  1a2e e749          	ld	(73,x),a
10545                     ; 2622 		MHL_MSC_DEBUG_PRINTF(printf("ERROR: Unknown RAP action code 0x%02X !!!\r\n", it6802->rxmsgdata[1]));
...
10553  1a3c 84            	pop	a
10554                     ; 2623 		MHL_MSC_DEBUG_PRINTF(printf("Send a RAPK with status code = 0x%02X\r\n", it6802->txmsgdata[1]));
...
10564  1a4c               L3544:
10565                     ; 2608 		case 0x00:
10565                     ; 2609 			MHL_MSC_DEBUG_PRINTF(printf("Poll\r\n"));
10567  1a4c ae24ba        	ldw	x,#L3154
10568  1a4f 8d000000      	callf	f_printf
10570                     ; 2610 			break;
10572  1a53 202a          	jra	L1154
10573  1a55               L5544:
10574                     ; 2611 		case 0x10:
10574                     ; 2612 			MHL_MSC_DEBUG_PRINTF(printf("Change to CONTENT_ON state\r\n"));
10576  1a55 ae249d        	ldw	x,#L5154
10577  1a58 8d000000      	callf	f_printf
10579                     ; 2613 			hdmirxset(0x61, 0x10, 0x00);
...
10591  1a6b               L7544:
10592                     ; 2615 		case 0x11:
10592                     ; 2616 			MHL_MSC_DEBUG_PRINTF(printf("Change to CONTENT_OFF state\r\n"));
10594  1a6b ae247f        	ldw	x,#L7154
10595  1a6e 8d000000      	callf	f_printf
10597                     ; 2617 			hdmirxset(0x61, 0x10, 0x10);
...
10707  1ac9               L1754:
10708                     ; 2739 		default :
10708                     ; 2740 			MHL_MSC_DEBUG_PRINTF(printf("ERROR: Unknown MSC_MSG sub-command code 0x%02X !!!\r\n", it6802->rxmsgdata[0]));
...
10740  1af5               L5254:
10741                     ; 2677 		case MSG_MSGE :
10741                     ; 2678 			MHL_MSC_DEBUG_PRINTF(printf("RX MSGE => "));
10743  1af5 ae241f        	ldw	x,#L7164
10744  1af8 8d000000      	callf	f_printf
10746                     ; 2679 			switch( it6802->rxmsgdata[1] ) {
10748  1afc 1e01          	ldw	x,(OFST+1,sp)
10749  1afe e64b          	ld	a,(75,x)
10751                     ; 2686 				default  :
10751                     ; 2687 					MHL_MSC_DEBUG_PRINTF(printf("ERROR: Unknown MSC_MSG status code 0x%02X !!!\r\n", it6802->rxmsgdata[1]));
10752  1b00 4d            	tnz	a
...
10767  1b17               L7254:
10768                     ; 2680 				case 0x00:
10768                     ; 2681 					MHL_MSC_DEBUG_PRINTF(printf("No Error\r\n"));
10770  1b17 ae2414        	ldw	x,#L5264
10771  1b1a 8d000000      	callf	f_printf
10773                     ; 2682 					break;
10775  1b1e ace11be1      	jpf	L5164
10776  1b22               L1354:
10777                     ; 2683 				case 0x01:
10777                     ; 2684 					MHL_MSC_DEBUG_PRINTF(printf("ERROR: Invalid sub-command code !!!\r\n"));
...
10820  1b57               L1454:
10821                     ; 2699 		case MSG_RCPE :
10821                     ; 2700 			 switch( it6802->rxmsgdata[1] ){
10823  1b57 1e01          	ldw	x,(OFST+1,sp)
10824  1b59 e64b          	ld	a,(75,x)
10826                     ; 2704 				default  : MHL_MSC_DEBUG_PRINTF(printf("ERROR: Unknown RCP status code !!!\r\n"));
10827  1b5b 4d            	tnz	a
...
10840  1b6d               L3454:
10841                     ; 2701 				case 0x00: MHL_MSC_DEBUG_PRINTF(printf("No Error\r\n")); break;
10843  1b6d ae2414        	ldw	x,#L5264
10844  1b70 8d000000      	callf	f_printf
10848  1b74 2010          	jra	L7364
10849  1b76               L5454:
10850                     ; 2702 				case 0x01: MHL_MSC_DEBUG_PRINTF(printf("ERROR: Ineffective RCP Key Code !!!\r\n")); break;
10852  1b76 ae238b        	ldw	x,#L1464
10853  1b79 8d000000      	callf	f_printf
10857  1b7d 2007          	jra	L7364
10858  1b7f               L7454:
10859                     ; 2703 				case 0x02: MHL_MSC_DEBUG_PRINTF(printf("Responder Busy ...\r\n")); break;
10861  1b7f ae2376        	ldw	x,#L3464
10862  1b82 8d000000      	callf	f_printf
10866  1b86               L7364:
10867                     ; 2706 			SwitchRCPResult(it6802,RCP_Result_Finish);
...
10877  1b91               L3554:
10878                     ; 2711 		case MSG_RAP  :
10878                     ; 2712 			mhl_parse_RAPkey(it6802);
10880  1b91 1e01          	ldw	x,(OFST+1,sp)
10881  1b93 8d011a01      	callf	L732f_mhl_parse_RAPkey
10883                     ; 2713 			break;
10885  1b97 2048          	jra	L5164
10886  1b99               L5554:
10887                     ; 2714 		case MSG_RAPK :
10887                     ; 2715 			 MHL_MSC_DEBUG_PRINTF(printf("RX RAPK  => "));
10889  1b99 ae2344        	ldw	x,#L7464
10890  1b9c 8d000000      	callf	f_printf
10892                     ; 2716 			 switch( it6802->rxmsgdata[1] ) {
10894  1ba0 1e01          	ldw	x,(OFST+1,sp)
10895  1ba2 e64b          	ld	a,(75,x)
10897                     ; 2721 				default  : MHL_MSC_DEBUG_PRINTF(printf("ERROR: Unknown RAP status code 0x%02X !!!\r\n", it6802->rxmsgdata[1]));
10898  1ba4 4d            	tnz	a
...
10917  1bbf               L7554:
10918                     ; 2717 				case 0x00: MHL_MSC_DEBUG_PRINTF(printf("No Error\r\n")); break;
10920  1bbf ae2414        	ldw	x,#L5264
10921  1bc2 8d000000      	callf	f_printf
10925  1bc6 2019          	jra	L5164
10926  1bc8               L1654:
10927                     ; 2718 				case 0x01: MHL_MSC_DEBUG_PRINTF(printf("ERROR: Unrecognized Action Code !!!\r\n")); break;
10929  1bc8 ae231e        	ldw	x,#L5564
10930  1bcb 8d000000      	callf	f_printf
10934  1bcf 2010          	jra	L5164
10935  1bd1               L3654:
10936                     ; 2719 				case 0x02: MHL_MSC_DEBUG_PRINTF(printf("ERROR: Unsupported Action Code !!!\r\n")); break;
10938  1bd1 ae22f9        	ldw	x,#L7564
10939  1bd4 8d000000      	callf	f_printf
10943  1bd8 2007          	jra	L5164
10944  1bda               L5654:
10945                     ; 2720 				case 0x03: MHL_MSC_DEBUG_PRINTF(printf("Responder Busy ...\r\n")); break;
...
11137                     ; 2785 	int  fwmodeflag = FALSE;
11139                     ; 2786 	int  wrburstflag = FALSE;
11141                     ; 2791 	if( offset==0x51)
11143  1c2b a30051        	cpw	x,#81
11144  1c2e 260e          	jrne	L5474
11145                     ; 2793 		if(wdata==0x80 )
11147  1c30 1e0c          	ldw	x,(OFST+6,sp)
11148  1c32 a30080        	cpw	x,#128
11149  1c35 2600          	jrne	L7474
11150                     ; 2794 			fwmodeflag  = TRUE;
11152  1c37               L7474:
11153                     ; 2795 		if(wdata==0x01 )
11155  1c37 1e0c          	ldw	x,(OFST+6,sp)
11156  1c39 a30001        	cpw	x,#1
11157  1c3c 2600          	jrne	L5474
11158                     ; 2796 			wrburstflag = TRUE;
11160  1c3e               L5474:
11161                     ; 2800 	mhlrxwr((unsigned char)offset, (unsigned char)wdata);
...
11169                     ; 2802 	mscreqsts = mscwait();
11171  1c48 8de31be3      	callf	L742f_mscwait
11173  1c4c 1f05          	ldw	(OFST-1,sp),x
11174                     ; 2803 	IT6802_MHL_DEBUG_PRINTF(printf("IT6802-MSC FIRE() %ld  \r\n",(int) mscreqsts));
...
11182                     ; 2805 	return (mscreqsts==SUCCESS)?SUCCESS:FAIL;
...
11194  1c65 87            	retf
11232                     ; 2810 static void cbus_send_mscmsg( struct it6802_dev_data *it6802 )
11232                     ; 2811 {
11233                     	switch	.text
11234  1c66               L352f_cbus_send_mscmsg:
11236  1c66 89            	pushw	x
11237       00000000      OFST:	set	0
11240                     ; 2812 	mhlrxwr(0x54, it6802->txmsgdata[0]);
...
11248                     ; 2813 	mhlrxwr(0x55, it6802->txmsgdata[1]);
...
11325  1c9e 84            	pop	a
11326                     ; 2828     MHLRX_DEBUG_PRINTF(printf("MHL_VER_MAJOR/MINOR=%02bX\r\n", devcap[1]));
...
11334  1cab 84            	pop	a
11335                     ; 2830     MHLRX_DEBUG_PRINTF(printf("DEV_TYPE="));
11337  1cac ae221b        	ldw	x,#L3305
11338  1caf 8d000000      	callf	f_printf
11340                     ; 2831     switch(devcap[2]&0x0F){
11342  1cb3 1e01          	ldw	x,(OFST+1,sp)
11343  1cb5 e602          	ld	a,(2,x)
11344  1cb7 a40f          	and	a,#15
11346                     ; 2836         default: MHLRX_DEBUG_PRINTF(printf("ERROR: Reserved for future use !!! ")); break;
11347  1cb9 4d            	tnz	a
...
11414                     ; 2839     MHLRX_DEBUG_PRINTF(printf("PLIM = %02bX\r\n", (devcap[2]&0x60)>>5));
...
11429                     ; 2841     MHLRX_DEBUG_PRINTF(printf("ADOPTER_ID_H=0x%02bX, ADOPTER_ID_L=0x%02bX\r\n", devcap[3], devcap[4]));
...
11441                     ; 2843     MHLRX_DEBUG_PRINTF(printf("VID_LINK_MODE:\r\n"));
11443  1d2b ae212f        	ldw	x,#L1605
11444  1d2e 8d000000      	callf	f_printf
11446                     ; 2844     MHLRX_DEBUG_PRINTF(printf("    SUPP_RGB444   = %02bX\r\n", (devcap[5]&0x01)>>0));
...
11460                     ; 2845     MHLRX_DEBUG_PRINTF(printf("    SUPP_YCBCR444 = %02bX\r\n", (devcap[5]&0x02)>>1));
...
11473                     ; 2846     MHLRX_DEBUG_PRINTF(printf("    SUPP_YCBCR422 = %02bX\r\n", (devcap[5]&0x04)>>2));
...
11487                     ; 2847     MHLRX_DEBUG_PRINTF(printf("    SUPP_PPIXEL   = %02bX\r\n", (devcap[5]&0x08)>>3));
...
11502                     ; 2848     MHLRX_DEBUG_PRINTF(printf("    SUPP_ISLANDS  = %02bX\r\n", (devcap[5]&0x10)>>4));
...
11516                     ; 2849     MHLRX_DEBUG_PRINTF(printf("    SUPP_VGA      = %02bX\r\n", (devcap[5]&0x20)>>5));
...
11531                     ; 2851     MHLRX_DEBUG_PRINTF(printf("AUD_LINK_MODE:\r\n"));
11533  1da7 ae2076        	ldw	x,#L7705
11534  1daa 8d000000      	callf	f_printf
11536                     ; 2852     MHLRX_DEBUG_PRINTF(printf("    SUPP_2CH  = %02bX\r\n", (devcap[6]&0x01)>>0));
...
11550                     ; 2853     MHLRX_DEBUG_PRINTF(printf("    SUPP_8CH  = %02bX\r\n", (devcap[6]&0x02)>>1));
...
11588                     ; 2858         MHLRX_DEBUG_PRINTF(printf("    VT_PHOTO    = %02bX\r\n", (devcap[7]&0x02)>>1));
...
11601                     ; 2859         MHLRX_DEBUG_PRINTF(printf("    VT_CINEMA   = %02bX\r\n", (devcap[7]&0x04)>>2));
...
11615                     ; 2860         MHLRX_DEBUG_PRINTF(printf("    VT_GAME     = %02bX\r\n", (devcap[7]&0x08)>>3));
...
11632  1e30               L5015:
11633                     ; 2863         MHLRX_DEBUG_PRINTF(printf("Not Support VIDEO_TYPE !!!\r\n"));
11635  1e30 ae1fb2        	ldw	x,#L3215
11636  1e33 8d000000      	callf	f_printf
11638  1e37               L1215:
11639                     ; 2865     MHLRX_DEBUG_PRINTF(printf("LOG_DEV_MAP:\r\n"));
11641  1e37 ae1fa3        	ldw	x,#L5215
11642  1e3a 8d000000      	callf	f_printf
11644                     ; 2866     MHLRX_DEBUG_PRINTF(printf("    LD_DISPLAY  = %02bX\r\n", (devcap[8]&0x01)>>0));
...
11658                     ; 2867     MHLRX_DEBUG_PRINTF(printf("    LD_VIDEO    = %02bX\r\n", (devcap[8]&0x02)>>1));
...
11671                     ; 2868     MHLRX_DEBUG_PRINTF(printf("    LD_AUDIO    = %02bX\r\n", (devcap[8]&0x04)>>2));
...
11685                     ; 2869     MHLRX_DEBUG_PRINTF(printf("    LD_MEDIA    = %02bX\r\n", (devcap[8]&0x08)>>3));
...
11700                     ; 2870     MHLRX_DEBUG_PRINTF(printf("    LD_TUNER    = %02bX\r\n", (devcap[8]&0x10)>>4));
...
11714                     ; 2871     MHLRX_DEBUG_PRINTF(printf("    LD_RECORD   = %02bX\r\n", (devcap[8]&0x20)>>5));
...
11729                     ; 2872     MHLRX_DEBUG_PRINTF(printf("    LD_SPEAKER  = %02bX\r\n", (devcap[8]&0x40)>>6));
...
11745                     ; 2873     MHLRX_DEBUG_PRINTF(printf("    LD_GUI      = %02bX\r\n", (devcap[8]&0x80)>>7));
...
11760                     ; 2875     MHLRX_DEBUG_PRINTF(printf("BANDWIDTH = %XMHz\r\n", devcap[9]*5));
...
11772                     ; 2877     MHLRX_DEBUG_PRINTF(printf("FEATURE_FLAG:\r\n"));
11774  1eee ae1eaf        	ldw	x,#L1515
11775  1ef1 8d000000      	callf	f_printf
11777                     ; 2878     MHLRX_DEBUG_PRINTF(printf("         RCP_SUPPORT = %02bX\r\n", (devcap[10]&0x01)>>0));
...
11791                     ; 2879     MHLRX_DEBUG_PRINTF(printf("         RAP_SUPPORT = %02bX\r\n", (devcap[10]&0x02)>>1));
...
11804                     ; 2880     MHLRX_DEBUG_PRINTF(printf("         SP_SUPPORT  = %02bX\r\n", (devcap[10]&0x04)>>2));
...
11818                     ; 2881     MHLRX_DEBUG_PRINTF(printf("    UCP_SEND_SUPPORT = %02bX\r\n", (devcap[10]&0x08)>>3));
...
11833                     ; 2882     MHLRX_DEBUG_PRINTF(printf("    UCP_RECV_SUPPORT = %02bX\r\n", (devcap[10]&0x10)>>4));
...
11847                     ; 2884     MHLRX_DEBUG_PRINTF(printf("DEVICE_ID_H=0x%02bX, DEVICE_ID_L=0x%02bX\r\n", devcap[11], devcap[12]));
...
11873  1f7b 84            	pop	a
11874  1f7c               L7615:
11875                     ; 2889     MHLRX_DEBUG_PRINTF(printf("INT_SIZE  = %02bX Bytes\r\n", (devcap[14]&0x0F)+1));
...
11888                     ; 2890     MHLRX_DEBUG_PRINTF(printf("STAT_SIZE = %02bX Bytes\r\n", ((devcap[14]&0xF0)>>4)+1));
...
11907  1fa4 87            	retf
11955                     ; 2900 static int read_devcap_hw( struct it6802_dev_data *it6802 )
11955                     ; 2901 {
11956                     	switch	.text
...
11964                     ; 2904 	IT6802_MHL_DEBUG_PRINTF(printf("IT6802-\r\nRead Device Capability Start ...\r\n"));
11966  1fa7 ae1d69        	ldw	x,#L1225
11967  1faa 8d000000      	callf	f_printf
11969                     ; 2906 	for(offset=0; offset<0x10; offset++) {
11971  1fae 0f01          	clr	(OFST+0,sp)
11972  1fb0               L3225:
11973                     ; 2908 		mhlrxwr(0x54, offset);
...
11981                     ; 2910 		if( mscfire(0x50, 0x40) == SUCCESS )
...
11991                     ; 2911 			it6802->Mhl_devcap[offset] = mhlrxrd(0x56);
...
12008                     ; 2916 		IT6802_MHL_DEBUG_PRINTF(printf("IT6802-DevCap[%X]=%X\r\n", (int)offset, (int)it6802->Mhl_devcap[offset]));
...
12062  201f 87            	retf
12102                     ; 2928 static void set_mhlint( unsigned char offset, unsigned char field )
12102                     ; 2929 {
12103                     	switch	.text
12104  2020               L162f_set_mhlint:
12106  2020 89            	pushw	x
12107       00000000      OFST:	set	0
12110                     ; 2930     mhlrxwr(0x54, offset);
...
12138  2041 87            	retf
12178                     ; 2935 static void set_mhlsts( unsigned char offset, unsigned char status )
12178                     ; 2936 {
12179                     	switch	.text
12180  2042               L362f_set_mhlsts:
12182  2042 89            	pushw	x
12183       00000000      OFST:	set	0
12186                     ; 2937     mhlrxwr(0x54, offset);
...
12194                     ; 2938     mhlrxwr(0x55, status);
...
12214  2063 87            	retf
12267                     ; 2942 static void write_burst(struct it6802_dev_data *it6802, int offset, int byteno )
12267                     ; 2943 {
12268                     	switch	.text
12269  2064               L562f_write_burst:
12271  2064 89            	pushw	x
12272       00000000      OFST:	set	0
12275                     ; 2944     set_wrburst_data(it6802, offset, byteno);
...
12285                     ; 2947     mscfire(0x51, 0x01);        // fire WRITE_BURST
...
12293                     ; 2949     mhlrxset(0x00, 0x80, EnCBusDbgMode<<7);  // Restore setting
...
12306  208c 87            	retf
12366                     ; 2952 static void set_wrburst_data(struct it6802_dev_data *it6802, int offset, int byteno )
12366                     ; 2953 {
12367                     	switch	.text
...
12375                     ; 2956     if( byteno<=2 || (offset+byteno)>16 ) {
12377  208f 9c            	rvf
...
12387  20a2               L1535:
12388                     ; 2957         MHLRX_DEBUG_PRINTF(printf("ERROR: Set Burst Write Data Fail !!!\r\n"));
12390  20a2 ae1d04        	ldw	x,#L3535
12391  20a5 8d000000      	callf	f_printf
12393                     ; 2958         return;
12395  20a9 203c          	jra	L414
12396  20ab               L7435:
12397                     ; 2962     mhlrxwr(0x54, 0x40+offset);
...
12406                     ; 2965         mhlrxset(0x00, 0x80, 0x00); // Disable CBUS Debug Mode when using Burst Write
...
12421  20ca               L5535:
12422                     ; 2974             mhlrxwr(0x59, it6802->txscrpad[i]);
...
12567                     ; 3005 	 mhlrxwr(0x5F, it6802->txscrpad[1]);
...
12576                     ; 3006 	 wrburstoff = 0;
12578  2135 725f0030      	clr	_wrburstoff
12579                     ; 3007 	 wrburstnum = 16;
12581  2139 3510002f      	mov	_wrburstnum,#16
12582                     ; 3008 	 write_burst(it6802,wrburstoff, wrburstnum);
...
12592                     ; 3009 	 MHLRX_DEBUG_PRINTF(printf("Set DSCR_CHG to 1 (TxSeqNum=%d) ...\r\n", TxWrBstSeq++));
...
12742                     ; 3035 	 mhlrxwr(0x5F, it6802->txscrpad[1]);
...
12751                     ; 3036 	 wrburstoff = 0;
12753  21c2 725f0030      	clr	_wrburstoff
12754                     ; 3037 	 wrburstnum = 16;
12756  21c6 3510002f      	mov	_wrburstnum,#16
12757                     ; 3038 	 write_burst(it6802,wrburstoff, wrburstnum);
...
12767                     ; 3039 	 MHLRX_DEBUG_PRINTF(printf("Set DSCR_CHG to 1 (TxSeqNum=%d) ...\r\n", TxWrBstSeq++));
...
12917                     ; 3065 	 mhlrxwr(0x5F, it6802->txscrpad[1]);
...
12926                     ; 3066 	 wrburstoff = 0;
12928  224f 725f0030      	clr	_wrburstoff
12929                     ; 3067 	 wrburstnum = 16;
12931  2253 3510002f      	mov	_wrburstnum,#16
12932                     ; 3068 	 write_burst(it6802,wrburstoff, wrburstnum);
...
12942                     ; 3069 	 MHLRX_DEBUG_PRINTF(printf("Set DSCR_CHG to 1 (TxSeqNum=%d) ...\r\n", TxWrBstSeq++));
...
13092                     ; 3095 	 mhlrxwr(0x5F, it6802->txscrpad[1]);
...
13101                     ; 3096 	 wrburstoff = 0;
13103  22dc 725f0030      	clr	_wrburstoff
13104                     ; 3097 	 wrburstnum = 16;
13106  22e0 3510002f      	mov	_wrburstnum,#16
13107                     ; 3098 	 write_burst(it6802,wrburstoff, wrburstnum);
...
13117                     ; 3099 	 MHLRX_DEBUG_PRINTF(printf("Set DSCR_CHG to 1 (TxSeqNum=%d) ...\r\n", TxWrBstSeq++));
...
13216                     ; 3112 	 mhlrxwr(0x5F, it6802->txscrpad[1]);
...
13225                     ; 3113 	 wrburstoff = 0;
13227  2337 725f0030      	clr	_wrburstoff
13228                     ; 3114 	 wrburstnum = 4;
13230  233b 3504002f      	mov	_wrburstnum,#4
13231                     ; 3115 	 write_burst(it6802,wrburstoff, wrburstnum);
...
13241                     ; 3117 	 MHLRX_DEBUG_PRINTF(printf("Set DSCR_CHG to 1 (TxSeqNum=%d) ...\r\n", TxWrBstSeq++));
...
13273  2378 87            	retf
13317                     ; 3123 static void v3d_unsupport2nd(struct it6802_dev_data *it6802)
13317                     ; 3124 {
13318                     	switch	.text
13319  2379               L303f_v3d_unsupport2nd:
13321  2379 89            	pushw	x
13322       00000000      OFST:	set	0
13325                     ; 3125 	 it6802->txscrpad[0]  = 0x00;
13327  237a 6f4c          	clr	(76,x)
13328                     ; 3126 	 it6802->txscrpad[1]  = 0x03;
13330  237c a603          	ld	a,#3
13331  237e e74d          	ld	(77,x),a
13332                     ; 3127 	 it6802->txscrpad[2]  = 0xFD;
13334  2380 a6fd          	ld	a,#253
13335  2382 e74e          	ld	(78,x),a
13336                     ; 3128 	 it6802->txscrpad[3]  = 0x00;
13338  2384 6f4f          	clr	(79,x)
13339                     ; 3130 	 mhlrxwr(0x5E, it6802->txscrpad[0]);
...
13347                     ; 3131 	 mhlrxwr(0x5F, it6802->txscrpad[1]);
...
13356                     ; 3132 	 wrburstoff = 0;
13358  239c 725f0030      	clr	_wrburstoff
13359                     ; 3133 	 wrburstnum = 4;
13361  23a0 3504002f      	mov	_wrburstnum,#4
13362                     ; 3134 	 write_burst(it6802,wrburstoff, wrburstnum);
...
13372                     ; 3135 	 MHLRX_DEBUG_PRINTF(printf("Set DSCR_CHG to 1 (TxSeqNum=%d) ...\r\n", TxWrBstSeq++));
...
13493  23ee               L7555:
13494                     ; 3159 	MHLRX_DEBUG_PRINTF(printf("block No =%x offset = %x \r\n",BlockNUM,offset));
...
13504                     ; 3162 	for(i=0;i<0x7F;i++)
13506  23fc 0f02          	clr	(OFST-1,sp)
13507  23fe               L3655:
13508                     ; 3164 		EDID_RAM_Write(offset,1 ,(pEDID+offset));
...
13678  247d 84            	pop	a
13679                     ; 3194 	chgbank(0);
13681  247e 5f            	clrw	x
13682  247f 8d440544      	callf	L711f_chgbank
13684                     ; 3196 }
13687  2483 87            	retf
13757                     ; 3199 static void EDIDRAMInitial(unsigned char *pIT6802EDID)
13757                     ; 3200 {
13758                     	switch	.text
...
13796                     ; 3218 			hdmirxwr(REG_RX_0C4,Block0_CheckSum);		//Port 0 Bank 0 CheckSum
...
13804                     ; 3219 			hdmirxwr(REG_RX_0C8,Block0_CheckSum);		//Port 1 Bank 0 CheckSum
...
13812                     ; 3221 			MHLRX_DEBUG_PRINTF(printf(" Block0_CheckSum = %x\r\n", Block0_CheckSum));
...
13822  24c9               L3565:
13823                     ; 3225 			Block1_CheckSum =  UpdateEDIDRAM(pIT6802EDID,1);
...
13831                     ; 3226 			MHLRX_DEBUG_PRINTF(printf(" Block1_CheckSum = %x\r\n", Block1_CheckSum));
13833  24d5 7b01          	ld	a,(OFST-2,sp)
13834  24d7 88            	push	a
13835  24d8 ae1c48        	ldw	x,#L1665
13836  24db 8d000000      	callf	f_printf
13838  24df 84            	pop	a
13839                     ; 3227 			u8_VSDB_Addr=Find_Phyaddress_Location(pIT6802EDID,1);
...
13888                     ; 3236 				MHLRX_DEBUG_PRINTF(printf("EDID Parsing OK\r\n"));
13890  2521 ae1c22        	ldw	x,#L7665
13891  2524 8d000000      	callf	f_printf
13893  2528               L7565:
13894                     ; 3211 	for(BlockNo=0;BlockNo<2;BlockNo++){
...
13903  2534               L054:
13904                     ; 3241 	DisableEDIDupdata();
13906  2534 8d5d245d      	callf	L113f_DisableEDIDupdata
13908                     ; 3242 }
13911  2538 5b05          	addw	sp,#5
13912  253a 87            	retf
13997                     ; 3245 static unsigned char Find_Phyaddress_Location(unsigned char *pEDID,unsigned char Block_Number)
13997                     ; 3246 {
13998                     	switch	.text
...
14026  2553               L7275:
14027                     ; 3257 	if((*(pEDID+AddStart))!=0x2 || (*(pEDID+AddStart+1))!=0x3)
...
14058  2579               L1375:
14059                     ; 3259 	End = (*(pEDID+AddStart+2));
...
14096                     ; 3267 		count=(*(pEDID+offset)) & 0x1f;
...
14112                     ; 3269         if(tag==0x03)
14114  25b6 7b04          	ld	a,(OFST-3,sp)
14115  25b8 a103          	cp	a,#3
14116  25ba 265b          	jrne	L5475
14117                     ; 3274 			if(	(*(pEDID+offset  ))==0x03 &&
14117                     ; 3275 				(*(pEDID+offset+1))==0x0C &&
14117                     ; 3276 				(*(pEDID+offset+2))==0x0    )
...
14170                     ; 3280 				txphyadr[1]=(*(pEDID+offset+4));
...
14315                     ; 3295 static void UpdateEDIDReg(unsigned char u8_VSDB_Addr, unsigned char CEC_AB, unsigned char CEC_CD, unsigned char Block1_CheckSum)
14315                     ; 3296 {
14316                     	switch	.text
...
14368                     ; 3309 	B_Block1_CheckSum=(Block1_CheckSum+CEC_AB+CEC_CD -B_Addr_AB-B_Addr_CD)%0x100;
...
14396                     ; 3312 	hdmirxwr(REG_RX_0C1,u8_VSDB_Addr);			//VSDB Start Address
...
14404                     ; 3313 	hdmirxwr(REG_RX_0C2,A_Addr_AB);					//Port 0 AB
...
14412                     ; 3314 	hdmirxwr(REG_RX_0C3,A_Addr_CD);				//Port 0 CD
...
14420                     ; 3315 	hdmirxwr(REG_RX_0C5,A_Block1_CheckSum);		//Port 0 Bank 1 CheckSum
...
14428                     ; 3317 	hdmirxwr(REG_RX_0C6,B_Addr_AB);					//Port 1 AB
...
14436                     ; 3318 	hdmirxwr(REG_RX_0C7,B_Addr_CD);				//Port 1 CD
...
14444                     ; 3319 	hdmirxwr(REG_RX_0C9,B_Block1_CheckSum);		//Port 1 Bank 1 CheckSum
...
14456  26e1 87            	retf
14491                     ; 3324 static void PhyAdrSet(void)
14491                     ; 3325 {
14492                     	switch	.text
14493  26e2               L123f_PhyAdrSet:
14497                     ; 3326 	txphyA = (txphyadr[0]&0xF0)>>4;
...
14534                     ; 3332 		txphylevel = 0;
14536  2720 725f0009      	clr	_txphylevel
14538  2724 203a          	jra	L3306
14539  2726               L1306:
14540                     ; 3333 	else if( txphyB==0 && txphyC==0 && txphyD==0 )
...
14641                     ; 3353 			rxphyadr[0][1] = 0x00;
14643  27a3 725f0006      	clr	_rxphyadr+1
14644                     ; 3354 			rxphyadr[1][0] = (txphyA<<4)+0x02;
...
14688                     ; 3366 			rxphyadr[1][0] = txphyadr[0];
14690  27df 55000e0007    	mov	_rxphyadr+2,_txphyadr
14691                     ; 3367 			rxphyadr[1][1] = (txphyC<<4)+0x02;
...
14713                     ; 3389 	rxphyA = (rxphyadr[0][0]&0xF0)>>4;
...
14747                     ; 3395 	rxphyA = (rxphyadr[1][0]&0xF0)>>4;
...
14766                     ; 3398 	rxphyD = (rxphyadr[1][1]&0x0F);
14768  285f c60008        	ld	a,_rxphyadr+3
14769  2862 a40f          	and	a,#15
14770  2864 c70001        	ld	_rxphyD,a
14771                     ; 3399 	MHLRX_DEBUG_PRINTF(printf(" PortB PhyAdr = %x, %x, %x, %x\r\n", rxphyA, rxphyB, rxphyC, rxphyD));
...
14781                     ; 3401 }
14784  287c 87            	retf
14820                     ; 3413 static void RCPinitQ(struct it6802_dev_data *it6802)
14820                     ; 3414 {
14821                     	switch	.text
14822  287d               L323f_RCPinitQ:
14826                     ; 3415 	it6802->RCPhead = 0;
14828  287d 6f71          	clr	(113,x)
14829                     ; 3416 	it6802->RCPtail = 0;
14831  287f 6f72          	clr	(114,x)
14832                     ; 3417 	it6802->RCPResult = RCP_Result_Finish;
14834  2881 a604          	ld	a,#4
14835  2883 e774          	ld	(116,x),a
14836                     ; 3418 }
14839  2885 87            	retf
14891                     ; 3420 void RCPKeyPush(unsigned char ucKey)
14891                     ; 3421 {
14892                     	switch	.text
...
14900                     ; 3424 	struct it6802_dev_data *it6802 = get_it6802_dev_data();
14902  2889 8d030203      	callf	L501f_get_it6802_dev_data
14904  288d 1f02          	ldw	(OFST-1,sp),x
14905                     ; 3428 	if( ( it6802->RCPhead % MAXRCPINDEX ) == ( ( it6802->RCPtail+1 ) % MAXRCPINDEX ) )
...
14925                     ; 3430 		return;
14927                     ; 3434 	it6802->RCPtail += 1;
14929  28b3 1e02          	ldw	x,(OFST-1,sp)
14930  28b5 6c72          	inc	(114,x)
14931                     ; 3435 	i=it6802->RCPtail % MAXRCPINDEX;
...
14943                     ; 3436 	it6802->RCPTxArray[i]=ucKey;
...
14955                     ; 3438 	SwitchRCPStatus(it6802,RCP_Transfer);
...
14967  28e1 87            	retf
15006                     ; 3442 static int RCPKeyPop(struct it6802_dev_data *it6802)
15006                     ; 3443 {
15007                     	switch	.text
15008  28e2               L523f_RCPKeyPop:
15010  28e2 89            	pushw	x
15011       00000000      OFST:	set	0
15014                     ; 3446 	if( (it6802->RCPhead % MAXRCPINDEX) == (it6802->RCPtail % MAXRCPINDEX) )
...
15060                     ; 3456 	MHLRX_DEBUG_PRINTF(printf("RCPKeyPop() key = %x \r\n",it6802->txmsgdata[1]));
...
15164  2961               L5516:
15165                     ; 3469 		case RCP_Result_OK:		MHLRX_DEBUG_PRINTF(printf("RCP_Result_OK \r\n"));   break;
15167  2961 ae1b94        	ldw	x,#L1226
15168  2964 8d000000      	callf	f_printf
15172  2968 2022          	jra	L7126
15173  296a               L7516:
15174                     ; 3470 		case RCP_Result_FAIL:		MHLRX_DEBUG_PRINTF(printf("RCP_Result_FAIL \r\n"));   break;
15176  296a ae1b81        	ldw	x,#L3226
15177  296d 8d000000      	callf	f_printf
15181  2971 2019          	jra	L7126
15182  2973               L1616:
15183                     ; 3471 		case RCP_Result_ABORT:	MHLRX_DEBUG_PRINTF(printf("RCP_Result_ABORT \r\n"));   break;
15185  2973 ae1b6d        	ldw	x,#L5226
15186  2976 8d000000      	callf	f_printf
15190  297a 2010          	jra	L7126
15191  297c               L3616:
15192                     ; 3472 		case RCP_Result_Transfer:	MHLRX_DEBUG_PRINTF(printf("RCP_Result_Transfer \r\n"));   break;
15194  297c ae1b56        	ldw	x,#L7226
15195  297f 8d000000      	callf	f_printf
15199  2983 2007          	jra	L7126
15200  2985               L5616:
15201                     ; 3473 		case RCP_Result_Finish:	MHLRX_DEBUG_PRINTF(printf("RCP_Result_Finish \r\n"));   break;
15203  2985 ae1b41        	ldw	x,#L1326
15204  2988 8d000000      	callf	f_printf
15208  298c               L7616:
15209                     ; 3474 		case RCP_Result_Unknown:	break;
15211  298c               L7126:
15212                     ; 3477 }
15215  298c 85            	popw	x
15216  298d 87            	retf
15262                     ; 3479 static void SwitchRCPStatus(struct it6802_dev_data *it6802,RCPState_Type RCPState)
15262                     ; 3480 {
15263                     	switch	.text
15264  298e               L133f_SwitchRCPStatus:
15266  298e 89            	pushw	x
15267       00000000      OFST:	set	0
15270                     ; 3481 	it6802->RCPState = RCPState;
...
15346                     ; 3495 						SwitchRCPStatus(it6802,RCP_Empty);
...
15361  29bb 87            	retf
15484                     ; 3513 static void IT6802MHLInterruptHandler(struct it6802_dev_data *it6802)
15484                     ; 3514 {
15485                     	switch	.text
...
15605                     ; 3547 	if( MHL04&0x01 ) {
15607  2a3d 7b05          	ld	a,(OFST-3,sp)
15608  2a3f a501          	bcp	a,#1
15609  2a41 2707          	jreq	L5536
15610                     ; 3549 		IT6802_DEBUG_INT_PRINTF(printf("IT6802-CBUS Link Layer TX Packet Done Interrupt ...\r\n"));
15612  2a43 ae1b0b        	ldw	x,#L7536
15613  2a46 8d000000      	callf	f_printf
15615  2a4a               L5536:
15616                     ; 3553 	if( MHL04&0x02 ) {
15618  2a4a 7b05          	ld	a,(OFST-3,sp)
15619  2a4c a502          	bcp	a,#2
15620  2a4e 272c          	jreq	L1636
15621                     ; 3555 		IT6802_DEBUG_INT_PRINTF(printf("IT6802-ERROR: CBUS Link Layer TX Packet Fail Interrupt ... \r\n"));
15623  2a50 ae1acd        	ldw	x,#L3636
15624  2a53 8d000000      	callf	f_printf
15626                     ; 3556 		IT6802_DEBUG_INT_PRINTF(printf("IT6802- TX Packet error Status reg15=%X\r\n", (int)mhlrxrd(0x15)));
...
15653  2a7c               L1636:
15654                     ; 3564 	if( MHL04&0x04 ) {
15656  2a7c 7b05          	ld	a,(OFST-3,sp)
15657  2a7e a504          	bcp	a,#4
15658  2a80 2707          	jreq	L7636
15659                     ; 3566 		IT6802_DEBUG_INT_PRINTF(printf("IT6802-CBUS Link Layer RX Packet Done Interrupt ...\r\n"));
15661  2a82 ae1a6d        	ldw	x,#L1736
15662  2a85 8d000000      	callf	f_printf
15664  2a89               L7636:
15665                     ; 3570 	if( MHL04&0x08 ) {
15667  2a89 7b05          	ld	a,(OFST-3,sp)
15668  2a8b a508          	bcp	a,#8
15669  2a8d 272c          	jreq	L3736
15670                     ; 3572 		 IT6802_DEBUG_INT_PRINTF(printf("IT6802-ERROR: CBUS Link Layer RX Packet Fail Interrupt ... \r\n"));
15672  2a8f ae1a2f        	ldw	x,#L5736
15673  2a92 8d000000      	callf	f_printf
15675                     ; 3574 		 IT6802_DEBUG_INT_PRINTF(printf("IT6802- TX Packet error Status reg15=%X\r\n", (int)mhlrxrd(0x15)));
...
16076  2c94               L5156:
16077                     ; 3705 				 mhlrxset(0x28, 0x08, 0x08);
...
16183  2d23 84            	pop	a
16184                     ; 3750 		hdmirxset(0x22, 0x04, 0x04);
...
16192  2d30 84            	pop	a
16193  2d31               L7356:
16194                     ; 3757 	if( MHL06&0x20 ) {
16196  2d31 7b08          	ld	a,(OFST+0,sp)
16197  2d33 a520          	bcp	a,#32
16198  2d35 271f          	jreq	L3456
16199                     ; 3759 		IT6802_DEBUG_INT_PRINTF(printf("it6802-CBUS MUTE Change Interrupt ...\r\n"));
16201  2d37 ae1635        	ldw	x,#L5456
16202  2d3a 8d000000      	callf	f_printf
16204                     ; 3760 		IT6802_DEBUG_INT_PRINTF(printf("it6802-Current CBUS MUTE Status = %X \r\n", (int)(mhlrxrd(0xB1)&0x10)>>4));
...
16259  2d86               L5556:
16260                     ; 3778 			IT6802_DEBUG_INT_PRINTF(printf("IT6802-DCapRdy Change from '1' to '0'\r\n"));
16262  2d86 ae159b        	ldw	x,#L3656
16263  2d89 8d000000      	callf	f_printf
16265  2d8d               L1556:
16266                     ; 3781 	if( MHL06&0x80 ) {
16268  2d8d 7b08          	ld	a,(OFST+0,sp)
16269  2d8f a580          	bcp	a,#128
16270  2d91 271e          	jreq	L5656
16271                     ; 3783 		IT6802_DEBUG_INT_PRINTF(printf("IT6802-VBUS Status Change Interrupt ...\r\n"));
16273  2d93 ae1571        	ldw	x,#L7656
16274  2d96 8d000000      	callf	f_printf
16276                     ; 3784 		IT6802_DEBUG_INT_PRINTF(printf("IT6802-Current VBUS Status = %X\r\n",(int) (mhlrxrd(0x10)&0x08)>>3));
...
16417  2e53               L1366:
16418                     ; 3813              MHLRX_DEBUG_PRINTF(printf("Adopter ID = 0x%02X %02X\r\n", mhlrxrd(0x83), mhlrxrd(0x84)));
...
16648  2f78 87            	retf
16756                     ; 3887 static void IT6802HDMIInterruptHandler(struct it6802_dev_data *it6802)
16756                     ; 3888 {
16757                     	switch	.text
...
16825                     ; 3911 	hdmirxwr(REG_RX_006, Reg06h);
...
16833                     ; 3912 	hdmirxwr(REG_RX_007, Reg07h);
...
16841                     ; 3913 	hdmirxwr(REG_RX_008, Reg08h);
...
16849                     ; 3914 	hdmirxwr(REG_RX_009, Reg09h);
...
16857                     ; 3915 	hdmirxwr(REG_RX_0D0, RegD0h);
...
17479                     ; 4145 	 MHLRX_DEBUG_PRINTF(printf(" P0_Rec_G_CS=%02bX  P0_Rec_G_RS=%02bX  \r\n",(hdmirxrd(REG_RX_1D6)&0x80)>>7 , (hdmirxrd(REG_RX_1D6)&0x7F)));
...
17504                     ; 4146 	 MHLRX_DEBUG_PRINTF(printf(" P0_Rec_R_CS=%02bX  P0_Rec_R_RS=%02bX  \r\n",(hdmirxrd(REG_RX_1D7)&0x80)>>7 , (hdmirxrd(REG_RX_1D7)&0x7F)));
...
17575                     ; 4155 	 MHLRX_DEBUG_PRINTF(printf(" P1_Rec_G_CS=%02bX  P1_Rec_G_RS=%02bX  \r\n",(hdmirxrd(REG_RX_1DE)&0x80)>>7 , (hdmirxrd(REG_RX_1DE)&0x7F)));
...
17600                     ; 4156 	 MHLRX_DEBUG_PRINTF(printf(" P1_Rec_R_CS=%02bX  P1_Rec_R_RS=%02bX  \r\n",(hdmirxrd(REG_RX_1DF)&0x80)>>7 , (hdmirxrd(REG_RX_1DF)&0x7F)));
...
17665  33e4 84            	pop	a
17666                     ; 4168 hdmirxset(0x22, 0x04, 0x04);
...
17710  3422 84            	pop	a
17711                     ; 4180 hdmirxset(0x3A, 0x04, 0x04);
...
17987  34e4 87            	retf
18024                     ; 4251 static void it6802AutoPortSelect(struct it6802_dev_data *it6802)
18024                     ; 4252 {
18025                     	switch	.text
18026  34e5               L143f_it6802AutoPortSelect:
18030                     ; 4270 }
18033  34e5 87            	retf
18144                     ; 4273 void get_vid_info( void )
18144                     ; 4274 {
18145                     	switch	.text
18146  34e6               f_get_vid_info:
18148  34e6 521b          	subw	sp,#27
18149       0000001b      OFST:	set	27
18152                     ; 4340 	InterLaced = (hdmirxrd(0x99)&0x02)>>1;
...
18162                     ; 4342 	HTotal   = ((hdmirxrd(0x9D)&0x3F)<<8) + hdmirxrd(0x9C);
...
18184                     ; 4343 	HActive  = ((hdmirxrd(0x9F)&0x3F)<<8) + hdmirxrd(0x9E);
...
18206                     ; 4344 	HFP      = ((hdmirxrd(0xA1)&0xF0)<<4) + hdmirxrd(0xA2);
...
18227                     ; 4345 	HSYNCW   = ((hdmirxrd(0xA1)&0x01)<<8) + hdmirxrd(0xA0);
...
18249                     ; 4346 	HSyncPol = hdmirxrd(0xA8)&0x04>>2;
...
18258                     ; 4348 	VTotal   = ((hdmirxrd(0xA4)&0x0F)<<8) + hdmirxrd(0xA3);
...
18280                     ; 4349 	VActive  = ((hdmirxrd(0xA4)&0xF0)<<4) + hdmirxrd(0xA5);
...
18301                     ; 4350 	VFP      = hdmirxrd(0xA7)&0x3F;
...
18310                     ; 4351 	VSYNCW   = hdmirxrd(0xA6)&0x1F;
...
18319                     ; 4352 	VSyncPol = (hdmirxrd(0xA8)&0x08)>>3;
...
18331                     ; 4355 	CurTMDSCLK             = (int)TMDSCLK;
...
18408  364c 87            	retf
18476                     ; 4374 void show_vid_info( void )
18476                     ; 4375 {
18477                     	switch	.text
18478  364d               f_show_vid_info:
18480  364d 5206          	subw	sp,#6
18481       00000006      OFST:	set	6
18484                     ; 4379 	int GCP_CD       = CD8BIT; //24 bits per pixel
18486                     ; 4381 	GCP_CD = ((hdmirxrd(0x99)&0xF0)>>4);
...
18593  36d0               L7447:
18594                     ; 4411 	default :
18594                     ; 4412 	MHLRX_DEBUG_PRINTF(printf("Output ColorDepth = 24 bits per pixel\r\n"));
...
18602  36d9               L3447:
18603                     ; 4405 	case 1 :
18603                     ; 4406 	MHLRX_DEBUG_PRINTF(printf("Output ColorDepth = 30 bits per pixel\r\n"));
...
18611  36e2               L5447:
18612                     ; 4408 	case 2 :
18612                     ; 4409 	MHLRX_DEBUG_PRINTF(printf("Output ColorDepth = 36 bits per pixel\r\n"));
18614  36e2 ae0b88        	ldw	x,#L5357
18615  36e5 8d000000      	callf	f_printf
18617                     ; 4410 	break;
18619  36e9               L1357:
18620                     ; 4416 	chgbank(2);
18622  36e9 ae0002        	ldw	x,#2
18623  36ec 8d440544      	callf	L711f_chgbank
18625                     ; 4417 	InColorMode = (hdmirxrd(0x15)&0x60)>>5;
...
18672  3729               L7547:
18673                     ; 4444 	default :
18673                     ; 4445 	MHLRX_DEBUG_PRINTF(printf("Input Color Mode = Reserved !!!\r\n"));
...
18681  3732               L1547:
18682                     ; 4429 	case 0 :
18682                     ; 4430 	MHLRX_DEBUG_PRINTF(printf("Input Color Mode = RGB444\r\n"));
...
18690  373b               L3547:
18691                     ; 4434 	case 1 :
18691                     ; 4435 	MHLRX_DEBUG_PRINTF(printf("Input Color Mode = YCbCr422\r\n"));
...
18699  3744               L5547:
18700                     ; 4439 	case 2 :
18700                     ; 4440 	MHLRX_DEBUG_PRINTF(printf("Input Color Mode = YCbCr444\r\n"));
18702  3744 ae0b08        	ldw	x,#L5557
18703  3747 8d000000      	callf	f_printf
18705                     ; 4443 	break;
18707  374b               L7457:
18708                     ; 4450 	OutColorMode = (hdmirxrd(0x65)&0x30)>>5;
...
18720                     ; 4451 	switch( OutColorMode ) {
...
18731  3768               L7647:
18732                     ; 4464 	default :
18732                     ; 4465 	MHLRX_DEBUG_PRINTF(printf("Output Color Mode = Reserved !!!\r\n"));
...
18740  3771               L1647:
18741                     ; 4452 	case 0 :
18741                     ; 4453 	MHLRX_DEBUG_PRINTF(printf("Output Color Mode = RGB444\r\n"));
...
18749  377a               L3647:
18750                     ; 4456 	case 1 :
18750                     ; 4457 	MHLRX_DEBUG_PRINTF(printf("Output Color Mode = YCbCr422\r\n"));
...
18758  3783               L5647:
18759                     ; 4460 	case 2 :
18759                     ; 4461 	MHLRX_DEBUG_PRINTF(printf("Output Color Mode = YCbCr444\r\n"));
18761  3783 ae0a8b        	ldw	x,#L1757
18762  3786 8d000000      	callf	f_printf
18764                     ; 4463 	break;
18766  378a               L3657:
18767                     ; 4470 	MHL_Mode     = ((hdmirxrd(0x0A)&0x40)>>6);
...
18780                     ; 4471 	MHL_CLK_Mode = ((mhlrxrd(0xB1)&0x07));
...
18827                     ; 4486 	MHLRX_DEBUG_PRINTF(printf("VActive = %d\r\n", CurVTiming.VActive));
...
18835                     ; 4487 	MHLRX_DEBUG_PRINTF(printf("HTotal = %d\r\n", CurVTiming.HTotal));
...
18843                     ; 4488 	MHLRX_DEBUG_PRINTF(printf("VTotal = %d\r\n", CurVTiming.VTotal));
...
18851                     ; 4489 	MHLRX_DEBUG_PRINTF(printf("HFrontPorch = %d\r\n", CurVTiming.HFrontPorch));
...
18859                     ; 4490 	MHLRX_DEBUG_PRINTF(printf("HSyncWidth = %d\r\n", CurVTiming.HSyncWidth));
...
18867                     ; 4491 	MHLRX_DEBUG_PRINTF(printf("HBackPorch = %d\r\n", CurVTiming.HBackPorch));
...
18875                     ; 4492 	MHLRX_DEBUG_PRINTF(printf("VFrontPorch = %d\r\n", CurVTiming.VFrontPorch));
...
18883                     ; 4493 	MHLRX_DEBUG_PRINTF(printf("VSyncWidth = %d\r\n", CurVTiming.VSyncWidth));
...
18891                     ; 4494 	MHLRX_DEBUG_PRINTF(printf("VBackPorch = %d\r\n", CurVTiming.VBackPorch));
...
18965  3896 84            	pop	a
18966                     ; 4519 	MHLRX_DEBUG_PRINTF(printf(" RegB5=%x \r\n",hdmirxrd(REG_RX_0B5)));
...
18975  38a5 84            	pop	a
18976                     ; 4520 	MHLRX_DEBUG_PRINTF(printf(" RegB9=%x \r\n",hdmirxrd(REG_RX_0B9)));
...
18985  38b4 84            	pop	a
18986                     ; 4521 	MHLRX_DEBUG_PRINTF(printf(" RegBA=%x \r\n",hdmirxrd(REG_RX_0BA)));
...
19154                     ; 4570 static unsigned char IT6802_DE3DFrame(unsigned char ena_de3d)
19154                     ; 4571 /*
19154                     ; 4572  * This function configures the HDMI DE3DFrame
19154                     ; 4573  * @param uunsigned char ena_de3d
19154                     ; 4574  * @return      TRUE
19154                     ; 4575  *              FALSE
19154                     ; 4576  */
19154                     ; 4577 {
19155                     	switch	.text
...
19295  3983 84            	pop	a
19296                     ; 4617     MHLRX_DEBUG_PRINTF(printf("        Record HDMI vender specific inforframe HB0 = 0x%02bX \r\n",it6802data->s_Current3DFr.HB0));
...
19304  3990 84            	pop	a
19305                     ; 4618     MHLRX_DEBUG_PRINTF(printf("        Record HDMI vender specific inforframe HB1 = 0x%02bX \r\n",it6802data->s_Current3DFr.HB1));
...
19313  399d 84            	pop	a
19314                     ; 4619     MHLRX_DEBUG_PRINTF(printf("        Record HDMI vender specific inforframe HB2 = 0x%02bX \r\n",it6802data->s_Current3DFr.HB2));
...
19322  39aa 84            	pop	a
19323                     ; 4620     MHLRX_DEBUG_PRINTF(printf("        Record HDMI vender specific inforframe PB0 = 0x%02bX \r\n",it6802data->s_Current3DFr.PB0));
...
19331  39b7 84            	pop	a
19332                     ; 4621     MHLRX_DEBUG_PRINTF(printf("        Record HDMI vender specific inforframe PB1 = 0x%02bX \r\n",it6802data->s_Current3DFr.PB1));
...
19340  39c4 84            	pop	a
19341                     ; 4622     MHLRX_DEBUG_PRINTF(printf("        Record HDMI vender specific inforframe PB2 = 0x%02bX \r\n",it6802data->s_Current3DFr.PB2));
...
19349  39d1 84            	pop	a
19350                     ; 4623     MHLRX_DEBUG_PRINTF(printf("        Record HDMI vender specific inforframe PB3 = 0x%02bX \r\n",it6802data->s_Current3DFr.PB3));
...
19358  39de 84            	pop	a
19359                     ; 4624     MHLRX_DEBUG_PRINTF(printf("        Record HDMI vender specific inforframe PB4 = 0x%02bX \r\n",it6802data->s_Current3DFr.PB4));
...
19367  39eb 84            	pop	a
19368                     ; 4625     MHLRX_DEBUG_PRINTF(printf("        Record HDMI vender specific inforframe PB5 = 0x%02bX \r\n",it6802data->s_Current3DFr.PB5));
...
19376  39f8 84            	pop	a
19377                     ; 4626     MHLRX_DEBUG_PRINTF(printf("        Record HDMI vender specific inforframe PB6 = 0x%02bX \r\n",it6802data->s_Current3DFr.PB6));
...
19385  3a05 84            	pop	a
19386                     ; 4627     MHLRX_DEBUG_PRINTF(printf("        Record HDMI vender specific inforframe PB7 = 0x%02bX \r\n",it6802data->s_Current3DFr.PB7));
...
19394  3a12 84            	pop	a
19395                     ; 4634             it6802data->de3dframe_config.LR_Reference             =  2; // Source of the 3D L/R reference.
19397  3a13 1e0a          	ldw	x,(OFST-1,sp)
19398  3a15 a602          	ld	a,#2
19399  3a17 e71a          	ld	(26,x),a
19400                     ; 4635             it6802data->de3dframe_config.FrameDominance           =  0; // Left or Right Eye is first in L/R image pair.
19402  3a19 1e0a          	ldw	x,(OFST-1,sp)
19403  3a1b 6f1b          	clr	(27,x)
19404                     ; 4636             it6802data->de3dframe_config.LR_Encoding              =  1; // Type of 3D L/R encoding
19406  3a1d 1e0a          	ldw	x,(OFST-1,sp)
19407  3a1f a601          	ld	a,#1
19408  3a21 e71c          	ld	(28,x),a
19409                     ; 4637             it6802data->de3dframe_config.TB_Reference             =  2; // Top/Bottom reference for vertically sub-sampled sources
19411  3a23 1e0a          	ldw	x,(OFST-1,sp)
19412  3a25 a602          	ld	a,#2
19413  3a27 e71d          	ld	(29,x),a
19414                     ; 4638             it6802data->de3dframe_config.OE_Reference             =  2; // Odd/Even reference for horizontally sub-sampled sources
19416  3a29 1e0a          	ldw	x,(OFST-1,sp)
19417  3a2b a602          	ld	a,#2
19418  3a2d e71e          	ld	(30,x),a
19419                     ; 4640             it6802data->de3dframe_config.NumActiveBlankLines      =  0; // Number of lines separating vertically packed L/R data to be removed (cropped)before being displayed
19421  3a2f 1e0a          	ldw	x,(OFST-1,sp)
19422  3a31 6f1f          	clr	(31,x)
19423                     ; 4641             it6802data->de3dframe_config.NumberOfEncodedLines     =  0; // Number of encoded lines in one L/R eye frame of the display data to be blanked out with "Blanking Color".
19425  3a33 1e0a          	ldw	x,(OFST-1,sp)
19426  3a35 6f20          	clr	(32,x)
19427                     ; 4642             it6802data->de3dframe_config.LeftEncodedLineLocation  = -1; // Active line number of 1st encoded line in one Left eye frame of the display data (-1=unknown).
19429  3a37 1e0a          	ldw	x,(OFST-1,sp)
19430  3a39 90aeffff      	ldw	y,#65535
19431  3a3d ef21          	ldw	(33,x),y
19432                     ; 4643             it6802data->de3dframe_config.RightEncodedLineLocation = -1; // Active line number of 1st encoded line in one Right eye frame of the display data (-1=unknown).
19434  3a3f 1e0a          	ldw	x,(OFST-1,sp)
19435  3a41 90aeffff      	ldw	y,#65535
19436  3a45 ef23          	ldw	(35,x),y
19437                     ; 4644             it6802data->de3dframe_config.BlankingColor            =  7; // Color to use when blanking (or masking off) any embedded L/R encoding
19439  3a47 1e0a          	ldw	x,(OFST-1,sp)
19440  3a49 a607          	ld	a,#7
19441  3a4b e725          	ld	(37,x),a
19442                     ; 4646             if(((it6802data->s_Current3DFr.PB4&0xE0) == HDMI_3DFORMAT_PRESENT) && ((it6802data->s_Current3DFr.PB5&0xF0) == FRAME_PACKING))
...
19459  3a63               L7777:
19460                     ; 4652                     if(t_3d_syncgen[i].Vic == it6802data->s_Current3DFr.VIC)
...
19470                     ; 4654                         break;
19471  3a72               L50001:
19472                     ; 4658                 v_total     = t_3d_syncgen[i].V_total;
...
19479                     ; 4659                 v_act_start = t_3d_syncgen[i].V_act_start;
...
19487                     ; 4660                 v_act_end   = t_3d_syncgen[i].V_act_end;
...
19495                     ; 4661                 v_sync_end  = t_3d_syncgen[i].V_sync_end;
...
19502                     ; 4662                 v_act_bspace = v_act_start - v_act_end;
...
19512  3aa5               L30001:
19513                     ; 4650                 while(t_3d_syncgen[i].Vic != 0xFF)
...
19523  3ab4               L5777:
19524                     ; 4665             if(((it6802data->s_Current3DFr.PB4&0xE0) == HDMI_3DFORMAT_PRESENT) && (!it6802data->DE3DFormat_HDMIFlag))
...
19536                     ; 4667                 it6802data->DE3DFormat_HDMIFlag = TRUE;
19538  3ac6 1e0a          	ldw	x,(OFST-1,sp)
19539  3ac8 e637          	ld	a,(55,x)
19540  3aca aa01          	or	a,#1
19541  3acc e737          	ld	(55,x),a
19542  3ace               L11001:
19543                     ; 4670             if(((it6802data->s_Current3DFr.PB4&0xE0) == HDMI_3DFORMAT_PRESENT) && (it6802data->DE3DFormat_HDMIFlag))
...
19558  3ae8               L436:
19559                     ; 4672                 if(((it6802data->s_Current3DFr.PB5&0xF0) == FRAME_PACKING) && (!it6802data->FramePacking_Flag))
...
19604                     ; 4682                     it6802data->newVIC = it6802data->s_Current3DFr.VIC;
19606  3b24 1e0a          	ldw	x,(OFST-1,sp)
19607  3b26 e626          	ld	a,(38,x)
19608  3b28 e733          	ld	(51,x),a
19609                     ; 4683                     if(it6802data->newVIC != it6802data->oldVIC)
...
19616                     ; 4685                         if((it6802data->s_Current3DFr.VIC == 0x3c) || (it6802data->s_Current3DFr.VIC ==0x3e) || (it6802data->s_Current3DFr.VIC == 0x13) ||
19616                     ; 4686                            (it6802data->s_Current3DFr.VIC == 0x04) ||(it6802data->s_Current3DFr.VIC ==0x20) || (it6802data->s_Current3DFr.VIC == 0x22))
...
19647  3b64               L52001:
19648                     ; 4689                             it6802data->de3dframe_config.NumActiveBlankLines  =  (unsigned char)v_act_bspace;
19650  3b64 7b08          	ld	a,(OFST-3,sp)
19651  3b66 1e0a          	ldw	x,(OFST-1,sp)
19652  3b68 e71f          	ld	(31,x),a
19653                     ; 4690                             it6802data->de3dframe_config.Format = VERT_PACKED_FULL; // Type of 3D source format is FRAME_PACKING(VERT_PACKED_FULL)
19655  3b6a 1e0a          	ldw	x,(OFST-1,sp)
19656  3b6c a603          	ld	a,#3
19657  3b6e e719          	ld	(25,x),a
19658                     ; 4695 				MHLRX_DEBUG_PRINTF(printf("IT680x - HDMI_3DFORMAT is FRAME_PACKING \r\n"));
19660  3b70 ae057f        	ldw	x,#L73001
19661  3b73 8d000000      	callf	f_printf
19664  3b77               L14001:
19665                     ; 4712                         it6802data->oldVIC = it6802data->newVIC;
19667  3b77 1e0a          	ldw	x,(OFST-1,sp)
19668  3b79 e633          	ld	a,(51,x)
19669  3b7b e732          	ld	(50,x),a
19670  3b7d 2008          	jra	L71001
19671  3b7f               L32001:
19672                     ; 4701                             it6802data->de3dframe_config.Format    =  6; // Type of 3D source format is UNDEFINED_FORMAT
19674  3b7f 1e0a          	ldw	x,(OFST-1,sp)
19675  3b81 a606          	ld	a,#6
19676  3b83 e719          	ld	(25,x),a
19677  3b85 20f0          	jra	L14001
19678  3b87               L71001:
19679                     ; 4716                 if(((it6802data->s_Current3DFr.PB5&0xF0) == TOP_AND_BOTTOM) && (!it6802data->TopAndBottom_Flag))
...
19694  3ba1               L046:
19695                     ; 4718                     if((it6802data->s_Current3DFr.VIC == 0x3c) || (it6802data->s_Current3DFr.VIC ==0x3e) || (it6802data->s_Current3DFr.VIC == 0x13) || (it6802data->s_Current3DFr.VIC == 0x04) || (it6802data->s_Current3DFr.VIC == 0x05) ||
19695                     ; 4719                        (it6802data->s_Current3DFr.VIC == 0x14) || (it6802data->s_Current3DFr.VIC ==0x20) || (it6802data->s_Current3DFr.VIC == 0x22) || (it6802data->s_Current3DFr.VIC == 0x1f) || (it6802data->s_Current3DFr.VIC == 0x10))
...
19778  3c18               L54001:
19779                     ; 4731                         it6802data->de3dframe_config.Format   =  6; // Type of 3D source format is UNDEFINED_FORMAT
19781  3c18 1e0a          	ldw	x,(OFST-1,sp)
19782  3c1a a606          	ld	a,#6
19783  3c1c e719          	ld	(25,x),a
19784  3c1e 20de          	jra	L37001
19785  3c20               L34001:
19786                     ; 4746                 if(((it6802data->s_Current3DFr.PB5&0xF0) == SIDE_BY_SIDE) && (!it6802data->SideBySide_Flag))
...
19801  3c3a               L446:
19802                     ; 4748                     if((it6802data->s_Current3DFr.VIC == 0x3c) || (it6802data->s_Current3DFr.VIC ==0x3e) || (it6802data->s_Current3DFr.VIC == 0x13) || (it6802data->s_Current3DFr.VIC == 0x04) || (it6802data->s_Current3DFr.VIC == 0x05) ||
19802                     ; 4749                        (it6802data->s_Current3DFr.VIC == 0x14) || (it6802data->s_Current3DFr.VIC ==0x20) || (it6802data->s_Current3DFr.VIC == 0x22) || (it6802data->s_Current3DFr.VIC == 0x1f) || (it6802data->s_Current3DFr.VIC == 0x10))
...
19906  3ccc 84            	pop	a
19907                     ; 4793 				MHLRX_DEBUG_PRINTF(printf("        LR_Reference             = %d \r\n",it6802data->de3dframe_config.LR_Reference));
...
19915  3cd9 84            	pop	a
19916                     ; 4794 				MHLRX_DEBUG_PRINTF(printf("        FrameDominance           = %d \r\n",it6802data->de3dframe_config.FrameDominance));
...
19924  3ce6 84            	pop	a
19925                     ; 4795 				MHLRX_DEBUG_PRINTF(printf("        LR_Encoding              = %d \r\n",it6802data->de3dframe_config.LR_Encoding));
...
19933  3cf3 84            	pop	a
19934                     ; 4796 				MHLRX_DEBUG_PRINTF(printf("        TB_Reference             = %d \r\n",it6802data->de3dframe_config.TB_Reference));
...
19942  3d00 84            	pop	a
19943                     ; 4797 				MHLRX_DEBUG_PRINTF(printf("        OE_Reference             = %d \r\n",it6802data->de3dframe_config.OE_Reference));
...
19951  3d0d 84            	pop	a
19952                     ; 4798 				MHLRX_DEBUG_PRINTF(printf("        NumActiveBlankLines      = %d \r\n",it6802data->de3dframe_config.NumActiveBlankLines));
...
19960  3d1a 84            	pop	a
19961                     ; 4799 				MHLRX_DEBUG_PRINTF(printf("        NumberOfEncodedLines     = %d \r\n",it6802data->de3dframe_config.NumberOfEncodedLines));
...
19969  3d27 84            	pop	a
19970                     ; 4800 				MHLRX_DEBUG_PRINTF(printf("        LeftEncodedLineLocation  = %d \r\n",it6802data->de3dframe_config.LeftEncodedLineLocation));
...
19979                     ; 4801 				MHLRX_DEBUG_PRINTF(printf("        RightEncodedLineLocation = %d \r\n",it6802data->de3dframe_config.RightEncodedLineLocation));
...
19988                     ; 4802 				MHLRX_DEBUG_PRINTF(printf("        BlankingColor            = %d \r\n",it6802data->de3dframe_config.BlankingColor ));
